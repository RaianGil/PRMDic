                ...
                <div class ="container-xl mb-4 p-18">
                        <div class ="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:dropdownlist id="ddlIdFieldNames" runat="server" class="form-select" Enabled="False"></asp:dropdownlist>
                                         </div>

                                         <div class="col-6 f-center">
                                <asp:label id="Label2" runat="server">Description Field Name</asp:label>
                                <asp:dropdownlist id="ddlDescriptionFieldNames" runat="server" class="form-select" Enabled="False"></asp:dropdownlist>
                                         </div>
                                         </div>
                                         </p>
                                ...
                                <asp:dropdownlist id="ddlDefaultSearchFieldsA" runat="server" class="form-select" Enabled="False"></asp:dropdownlist>
                                         </div>

                                         <div class="col-4 f-center">
                                <asp:label id="Label4" runat="server">Default Search Field B</asp:label>
                                <asp:dropdownlist id="ddlDefaultSearchFieldsB" runat="server" class="form-select" Enabled="False"></asp:dropdownlist>
                                         </div>

                                         <div class="col-4 f-center">
                                <asp:label id="Label5" runat="server">Maintenance Page Path</asp:label>
                                <asp:textbox id="txtMaintenancePagePath" runat="server" class="form-control" Enabled="False"></asp:textbox>
                                         </div>
                                         </div>
                                         </p>
