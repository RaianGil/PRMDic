<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CorporatePolicyQuote.aspx.cs"
    ...
    <%@ Register TagPrefix="MaskedInput" Namespace="MaskedInput" Assembly="MaskedInput" %>
        ...
        <script type="text/javascript">
            ...
            function ShowDateTimePickerEntryDate() {
                ...
                <div class="container-xl mb-4" style="padding-left:18px; padding-right:18px;">
                    <div class="row">
                        ...
                        <div class="col-md-8" style="text-align:right;">
                            ...
                            <asp:Button ID="btnConvert" runat="server" Font-Size="9pt" Font-Names="Tahoma" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" style="margin-bottom: 4px;" OnClick="btnConvert_Click" Text="Convert Excess" />
                            <asp:Button ID="btnPrint" runat="server" Font-Names="Tahoma" Font-Size="9pt" Text="Print" OnClick="btnPrint_Click" style="margin-bottom: 4px;" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" />
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:Panel runat="server" ID="pnlPolicy">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="Div1" class="mb-3 row" runat="server" visible="false">
                                        ...
                                        <div id="Div2" class="mb-3 row" runat="server" visible="false">
                                        ...
                                        <div id="Div3" class="mb-3 row" runat="server" visible="false">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <MaskedInput:MaskedTextBox ID="txtHomePhone" onKeyDown="KeyDownHandler();" onkeyup="KeyDownHandler();" runat="server" CssClass="form-control telefoneFormat" Font-Names="Tahoma" Font-Size="8pt" IsDate="False" Mask="(999) 999-9999" MaxLength="20"></MaskedInput:MaskedTextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <MaskedInput:MaskedTextBox ID="txtWorkPhone" runat="server" CssClass="form-control telefoneFormat" Font-Names="Tahoma" Font-Size="8pt" IsDate="False" Mask="(999) 999-9999" MaxLength="20"></MaskedInput:MaskedTextBox>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <MaskedInput:MaskedTextBox ID="TxtCellular" runat="server" CssClass="form-control telefoneFormat" Font-Names="Tahoma" Font-Size="8pt" IsDate="False" Mask="(999) 999-9999" MaxLength="20"></MaskedInput:MaskedTextBox>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <asp:Button ID="btnCalcCharge" b runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" style="margin-left: 10px; height: 29px;" Font-Names="Tahoma" BackColor="#BB1509" ForeColor="White" OnClick="CalculateCharge" Font-Size="9pt" Text="Calculate" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="TxtRetroactiveDate" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker2();"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="txtEffDt" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker();"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="txtExpDt" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" IsDate="True" onclick="ShowDateTimePicker12();"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="txtEntryDate" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" IsDate="True"></asp:TextBox>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-5">
                                                <asp:TextBox ID="txtGapBegDate" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker6();"></asp:TextBox>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <asp:TextBox ID="txtGapEndDate" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker7();"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-5">
                                                <asp:TextBox ID="txtGapBegDate2" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker8();"></asp:TextBox>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <asp:TextBox ID="txtGapEndDate2" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker9();"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-5">
                                                <asp:TextBox ID="txtGapBegDate3" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker10();"></asp:TextBox>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <asp:TextBox ID="txtGapEndDate3" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker11();"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12" style="height:29.2px;">
                                                        <div>
                                                            <%--<input size="10" type="text" class="form-control" value="12-02-2012">--%>
                                                                <maskedinput:maskedtextbox id="txtPriPolEffecDate1" Height="29.2px" Font-Size="8pt" Font-Names="Tahoma" RUNAT="server" ISDATE="True" CssClass="form-control fechaFormat"></maskedinput:maskedtextbox>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <asp:TextBox ID="txtEndoEffDate" runat="server" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker5();" CssClass="form-control fechaFormat"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <asp:TextBox ID="txtRetroEffDate" runat="server" Font-Names="Tahoma" CssClass="form-control fechaFormat" Font-Size="8pt" onclick="ShowDateTimePickerEndoRetroDate();"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-12">
                                                <asp:DataGrid ID="dtEndorsement" runat="server" AllowPaging="True" AlternatingItemStyle-BackColor="#BB1509" AlternatingItemStyle-CssClass="HeadForm3" AutoGenerateColumns="False" BackColor="White" BorderColor="#D6E3EA" BorderStyle="Solid" BorderWidth="1px"
                                                    ...
                                                    OnItemCommand="dtEndorsement_ItemCommand" PageSize="8" TabIndex="9" Width="90%" onselectedindexchanged="dtEndorsement_SelectedIndexChanged" HeaderStyle-ForeColor="white">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-12">
                                            <asp:DataGrid ID="DtSearchPayments" runat="server" AllowPaging="True" AlternatingItemStyle-BackColor="#BB1509" AlternatingItemStyle-CssClass="HeadForm3" AutoGenerateColumns="False" BackColor="White" BorderColor="#D6E3EA" BorderStyle="Solid" BorderWidth="1px"
                                                ...
                                                OnItemCommand="DtSearchPayments_ItemCommand1" PageSize="8" TabIndex="9" Width="90%" HeaderStyle-ForeColor="white">
                                                <FooterStyle BackColor="Navy" ForeColor="#003399" />
                                                <EditItemStyle BackColor="White" HorizontalAlign="Center" />
                                                <SelectedItemStyle BackColor="White" HorizontalAlign="Center" />
                                                <PagerStyle BackColor="White" CssClass="Numbers" Font-Names="Tahoma" ForeColor="Blue" HorizontalAlign="Left" Mode="NumericPages" PageButtonCount="20" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <asp:TextBox ID="txtQuoteRetroDate" runat="server" Columns="30" CssClass="form-control fechaFormat" Font-Names="Tahoma" Font-Size="8pt" onclick="ShowDateTimePicker4();"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3 row">
                                                        <asp:Label ID="Label10" runat="server" CssClass="col-md-3 col-form-labe label-vertical-align" Font-Names="Tahoma" Font-Size="8.29pt">Excess Rate:</asp:Label>
                                                        <div class="col-md-9">
                                                            <asp:DropDownList ID="ddlLimits" runat="server" AutoPostBack="True" CssClass="form-select" Font-Names="Tahoma" Font-Size="8pt" OnSelectedIndexChanged="ddlLimits_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3 row">
                                                        <asp:Label ID="Label11" runat="server" CssClass="col-md-3 col-form-labe label-vertical-align" visible="false" Font-Names="Tahoma" Font-Size="9pt">Specialty:</asp:Label>
                                                        <div class="col-md-9">
                                                            <asp:DropDownList ID="ddPrimarylPolicyClass" visible="false" runat="server" AutoPostBack="True" CssClass="form-select" Font-Names="Tahoma" Font-Size="8pt" OnSelectedIndexChanged="ddlPolicyClass_SelectedIndexChanged1">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3 row">
                                                        <asp:Label ID="Label39" runat="server" CssClass="col-md-3 col-form-labe label-vertical-align" Font-Names="Tahoma" Font-Size="9pt">Specialty:</asp:Label>
                                                        <div class="col-md-9">
                                                            <asp:DropDownList ID="ddlPolicyClass" runat="server" AutoPostBack="True" Font-Names="Tahoma" CssClass="form-select" Font-Size="8pt" OnSelectedIndexChanged="ddlPolicyClass_SelectedIndexChanged1">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3 row">
                                                        <asp:Label ID="Label44" runat="server" CssClass="col-md-3 col-form-labe label-vertical-align" Font-Names="Tahoma" Font-Size="9pt">Excess Mature Rate:</asp:Label>
                                                        <div class="col-md-9">
                                                            <asp:TextBox ID="txtRate4" runat="server" Font-Names="Tahoma" CssClass="form-control" Font-Size="8pt"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <asp:DataGrid ID="DtGridCorpaoratePol" runat="server" AlternatingItemStyle-BackColor="#BB1509" AlternatingItemStyle-CssClass="HeadForm3" AutoGenerateColumns="False" BackColor="White" BorderColor="#D6E3EA" BorderStyle="Solid" BorderWidth="1px" CellPadding="0"
                                                        ...
                                                        OnItemCommand="DtGridCorpaoratePol_ItemCommand" PageSize="8" TabIndex="9" Width="90%" onselectedindexchanged="DtGridCorpaoratePol_SelectedIndexChanged" HeaderStyle-ForeColor="white">
                                                        <FooterStyle BackColor="Navy" ForeColor="#003399" />
                                                        <EditItemStyle BackColor="White" HorizontalAlign="Center" />
                                                        <SelectedItemStyle BackColor="White" HorizontalAlign="Center" />
                                                        <PagerStyle BackColor="White" CssClass="Numbers" Font-Names="Tahoma" ForeColor="Blue" HorizontalAlign="Left" Mode="NumericPages" PageButtonCount="20" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="ExcessRate" HeaderText="Excess Rate">
                                                                <HeaderStyle Width="75px" />
                                                                <ItemStyle Font-Names="Tahoma" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                                                            </asp:BoundColumn>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label16" runat="server" CssClass="col-md-3 col-form-labe label-vertical-align" Font-Names="Tahoma" Font-Size="9pt">Excess Rate %:</asp:Label>
                                        <div class="col-md-9">
                                            <asp:TextBox ID="txtDiscount" runat="server" CssClass="form-control" Font-Names="Tahoma" Font-Size="9pt" MaxLength="20">15%</asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label36" runat="server" CssClass="col-md-3 col-form-labe label-vertical-align" Font-Names="Tahoma" Font-Size="9pt">Excess Premium</asp:Label>
                                        <div class="col-md-9">
                                            <asp:TextBox ID="txtTotalExcessPremium" runat="server" CssClass="form-control" Font-Names="Tahoma" Font-Size="9pt" MaxLength="20"></asp:TextBox>
                                        </div>
                                    </div>
                            ...
                            <hr />
                            <div class="row">
                                <asp:Label ID="Label2" CssClass="fs-11 fw-bold" runat="server">Primary - Technicians & Nurses
                                </asp:Label>
                                <asp:textbox id="TxtID" CSSCLASS="form-control fs-txt-s" runat="server" Visible="False"></asp:textbox>
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        <div class="col-md-3"></div>
                                        <asp:Label ID="Label4" CssClass="col-md-2 col-form-labe fs-lbl-s label-vertical-align" runat="server">Primary</asp:Label>
                                        <asp:Label ID="Label5" CssClass="col-md-1 col-form-labe fs-lbl-s label-vertical-align" runat="server">Rate %</asp:Label>
                                        <asp:Label ID="Label6" CssClass="col-md-2 col-form-labe fs-lbl-s label-vertical-align" runat="server">Premium</asp:Label>
                                        <asp:Label ID="Label7" CssClass="col-md-2 col-form-labe fs-lbl-s label-vertical-align" runat="server">Quantity</asp:Label>
                                        <asp:Label ID="Label14" CssClass="col-md-2 col-form-labe fs-lbl-s label-vertical-align" runat="server">Premium</asp:Label>
                                    </div>
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label15" CssClass="col-md-3 col-form-labe fs-lbl-s label-vertical-align" runat="server">Physicians Assistant</asp:Label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label20" CssClass="col-md-3 col-form-labe fs-lbl-s label-vertical-align" runat="server">Nurse Midwife</asp:Label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label22" CssClass="col-md-3 col-form-labe fs-lbl-s label-vertical-align" runat="server">Nurse Anesthetist
                                        </asp:Label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label23" CssClass="col-md-3 col-form-labe fs-lbl-s label-vertical-align" runat="server">Nurse Practitioner
                                        </asp:Label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label24" CssClass="col-md-3 col-form-labe fs-lbl-s label-vertical-align" runat="server">All Other Personel
                                        </asp:Label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label25" runat="server" CssClass="col-md-3 col-form-labe fs-lbl-s label-vertical-align">Total:</asp:Label>
                                        <div class="col-md-2">
                                        </div>
                                        <div class="col-md-1">
                            ...
                            <hr />
                            <div class="row">
                                <asp:Label ID="Label26" runat="server" CssClass="fs-11 fw-bold">Excess - Technicians & Nurses</asp:Label>
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        <div class="col-md-3"></div>
                                        <asp:Label ID="Label27" runat="server" CssClass="col-md-2 col-form-labe fs-lbl-s label-vertical-align">Excess</asp:Label>
                                        <asp:Label ID="Label28" runat="server" CssClass="col-md-1 col-form-labe fs-lbl-s label-vertical-align">Rate %</asp:Label>
                                        <asp:Label ID="Label29" runat="server" CssClass="col-md-2 col-form-labe fs-lbl-s label-vertical-align">Premium</asp:Label>
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label30" runat="server" CssClass="col-md-3 col-form-labe fs-lbl-s label-vertical-align">Nurse Practitioner
                                        </asp:Label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label311" runat="server" CssClass="col-md-3 col-form-labe fs-lbl-s label-vertical-align">All Other Personel
                                        </asp:Label>
                                        <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3 row">
                                        <asp:Label ID="Label37" runat="server" CssClass="col-md-10 col-form-labe label-vertical-align" Font-Names="Tahoma" Font-Size="9pt" Font-Bold="True" style="text-align:end;">Total Excess Corporate Premium:</asp:Label>
                                        <div class="col-md-2">
                                            <asp:TextBox ID="txtTotalExcessCorporate" runat="server" CssClass="form-control" Font-Names="Tahoma" Font-Size="9pt" MaxLength="20"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <%-- contenido que va en Endorsement --%>
                            ...
                            <asp:Button ID="btnHideEndoPanel" runat="server" BackColor="#BB1509" BorderColor="#BB1509" BorderStyle="Solid" BorderWidth="1px" CssClass="style22" Font-Names="Tahoma" ForeColor="White" Height="23px" onclick="btnHideEndoPanel_Click" tabIndex="72" Text="X"
