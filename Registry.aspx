...
<%@ Page language="c#" Inherits="EPolicy.Registry" CodeFile="Registry.aspx.cs" %>
...
<HTML>
	<HEAD>
		...
		<script>
		    $(function() {
		        $('#<%= txtASSMCADate.ClientID %>').datepicker({
		            changeMonth: true,
		            changeYear: true
		        });

		        $('#<%= txtDEADate.ClientID %>').datepicker({
		            changeMonth: true,
		            changeYear: true
		        });

		        $('#<%= txtTribunalDate.ClientID %>').datepicker({
		            changeMonth: true,
		            changeYear: true
		        });

		        $('#<%= txtCDMDate.ClientID %>').datepicker({
		            changeMonth: true,
		            changeYear: true
		        });

		        $('#<%= txtGStandingDate.ClientID %>').datepicker({
		            changeMonth: true,
		            changeYear: true
		        });
		        ...
		        $('#<%= txtLicenciaDate.ClientID %>').datepicker({
		            changeMonth: true,
		            changeYear: true
		        });
		         $('#<%= txtCannabisDate.ClientID %>').datepicker({
		            changeMonth: true,
		            changeYear: true
		        });
		    });
		    ...
		    function ShowDateTimePicker() {
		        $('#<%= txtASSMCADate.ClientID %>').datepicker('show');
		    }

		    function ShowDateTimePicker2() {
		        $('#<%= txtDEADate.ClientID %>').datepicker('show');
		    }

		    function ShowDateTimePicker3() {
		        $('#<%= txtTribunalDate.ClientID %>').datepicker('show');
		    }

		    function ShowDateTimePicker4() {
		        $('#<%= txtCDMDate.ClientID %>').datepicker('show');
		    }

		    function ShowDateTimePicker5() {
		        $('#<%= txtGStandingDate.ClientID %>').datepicker('show');
		    }
		    ...
		    function ShowDateTimePicker13() {
		        $('#<%= txtLicenciaDate.ClientID %>').datepicker('show');
		    }
		     function ShowDateTimePicker14() {
		        $('#<%= txtCannabisDate.ClientID %>').datepicker('show');
		    }
		...
		<form id="form1" runat="server">
						<P align="center">
							<TABLE id="Table9" style="WIDTH: 762px; HEIGHT: 369px" cellSpacing="0" 
									...
									<TD style="FONT-SIZE: 0pt; text-align: right;" align="center" class="style22" 
                                        valign="bottom">
													...
													<asp:button id="btnPrint" tabIndex="5" runat="server" Height="23px" 
														...
														ForeColor="White" BorderWidth="0px" BorderColor="#400000" Font-Names="Tahoma" Font-Size="9pt"
														BackColor="#400000" onclick="btnPrint_Click" style="margin-bottom: 0px; margin-right: 1px;"></asp:button>
								...
								<TR>
									<TD vAlign="middle" align="center" class="style3" colspan="2">
												    ...
												    <TABLE id="Table5" style="WIDTH: 100%; HEIGHT: 85px; margin-left: 0px;" 
														...
														<TR>
															...
															<td class="style109">
																&#160;</td>
															<TD class="style16">
                                                                <asp:Label ID="LblDate13" RUNAT="server" CSSCLASS="style39" 
                                                            Font-Names="Tahoma" Font-Size="9pt" HEIGHT="22px" WIDTH="100px">Practice 
                                                                Info:</asp:Label>
                                                            </TD>
															<TD class="style32">
																<asp:Label ID="LblDate30" RUNAT="server" CssClass=" " 
                                                            Font-Names="Tahoma" Font-Size="9pt" HEIGHT="22px" style="font-weight: 700" 
                                                            WIDTH="111px">Grad. Date</asp:Label>
                                                            </TD>
															<td class="style114">
																 &#160;</td>
															<td class="style37" colspan="3">
                                                                <asp:Label ID="LblDate23" RUNAT="server" CSSCLASS="style39" Font-Names="Tahoma" 
                                                                    Font-Size="9pt" HEIGHT="22px" WIDTH="150px">Medical Practice Type:</asp:Label>
                                                            </td>
														</TR>
														<TR>
															<TD class="style59">
															...
															<td class="style43">
                                                                <asp:CheckBox ID="chkASSMCA" runat="server" CssClass=" " Text=" " 
                                                                    AutoPostBack="True" oncheckedchanged="RevealControls" />
                                                                <asp:Label ID="LblDate1" RUNAT="server" CSSCLASS=" " Font-Names="Tahoma" 
                                                                    Font-Size="9pt" HEIGHT="16px" WIDTH="86px" style="text-align: left">ASSMCA:</asp:Label>
                                                            </td>
															<TD class="style103">
                                                                <asp:TextBox ID="txtASSMCADate" runat="server" Columns="30" 
                                                            ...
                                                            <td class="style37" colspan="2" rowspan="8">
																<asp:CheckBoxList ID="chkMedicalPractice" runat="server" AutoPostBack="True" 
                                                                    ...
                                                                    style="font-size: 10pt; font-family: Tahoma" Width="210px">
                                                                    <asp:ListItem>Solo Physician</asp:ListItem>
                                                                    <asp:ListItem>Employed Physician</asp:ListItem>
                                                                    <asp:ListItem>Partnership</asp:ListItem>
                                                                    <asp:ListItem>Group Member</asp:ListItem>
                                                                    <asp:ListItem>Professional Association</asp:ListItem>
                                                                    <asp:ListItem>Professional Corporation</asp:ListItem>
														...
														<TR>
															...
															<td class="style86">
                                                                <asp:CheckBox ID="chkDEA" runat="server" CssClass=" " Text=" " 
                                                                    AutoPostBack="True" oncheckedchanged="RevealControls" />
                                                                <asp:Label ID="LblDate5" RUNAT="server" CSSCLASS=" " Font-Names="Tahoma" 
                                                                    Font-Size="9pt" HEIGHT="16px" WIDTH="114px">DEA:</asp:Label>
                                                            </td>
															<TD class="style104">
                                                                <asp:TextBox ID="txtDEADate" runat="server" Columns="30" 
                                                                    CssClass=" " Font-Names="Tahoma"
                                                                    Font-Size="9pt" Height="18px" IsDate="True" 
														...
														<TR>
															...
															<td class="style86" valign="middle">
                                                                &#160;</td>
                                                            <td class="style103">
														...
														<tr>
															<td class="style55">
																 &#160;</td>
														    <td class="style86" valign="middle">
                                                                <asp:CheckBox ID="chkRegistroMedico" runat="server" AutoPostBack="True" 
                                                                    CssClass=" " oncheckedchanged="RevealControls" Text=" " />
                                                                <asp:Label ID="LblDate31" RUNAT="server" CSSCLASS=" " Font-Names="Tahoma" 
                                                                    Font-Size="9pt" HEIGHT="31px" WIDTH="105px">REGISTRO MÉDICO:</asp:Label>
                                                            </td>
                                                            <td class="style103">
                                                                <asp:TextBox ID="txtLicenciaDate" runat="server" Columns="30" CssClass=" " 
														...
														<tr>
                                                            <td class="style55">
                                                                 &nbsp;</td>
                                                            <td class="style16">
                                                                <asp:CheckBox ID="chkCDM" runat="server" AutoPostBack="True" CssClass=" " 
                                                                    oncheckedchanged="RevealControls" Text=" " />
                                                                <asp:Label ID="LblDate7" runat="server" CssClass=" " Font-Names="Tahoma" 
                                                                    Font-Size="9pt" Height="16px" style="font-size: 9pt" Width="132px">COLEGIO 
                                                                DE MEDICOS:</asp:Label>
                                                            </td>
                                                            <td class="style103">
                                                                <br />
                                                                <asp:TextBox ID="txtCDMDate" runat="server" Columns="30" CssClass=" " 
                                                                    Font-Names="Tahoma" Font-Size="9pt" Height="18px" IsDate="True" 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="style16">
                                                                <asp:CheckBox ID="chkGStanding" runat="server" AutoPostBack="True" CssClass=" " 
                                                                    oncheckedchanged="RevealControls" Text=" " />
                                                                <asp:Label ID="LblDate27" runat="server" CssClass=" " Font-Names="Tahoma" 
                                                                    Font-Size="9pt" Height="16px" style="font-size: 9pt" Width="132px">GOOD 
                                                                STANDING:</asp:Label>
                                                            </td>
                                                            <td class="style103">
                                                                <asp:TextBox ID="txtGStandingDate" runat="server" Columns="30" CssClass=" " 
                                                                    Font-Names="Tahoma" Font-Size="9pt" Height="18px" IsDate="True" 
                                                                    onclick="ShowDateTimePicker5();" TabIndex="44" Width="79px"></asp:TextBox>
                                                            </td>
                                                            <td class="style109">
                                                                &nbsp;</td>
                                                            <td class="style16">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="style16">
                                                                <asp:CheckBox ID="chkJDL" runat="server" AutoPostBack="True" CssClass=" " 
                                                                    oncheckedchanged="RevealControls" Text=" " />
                                                                <asp:Label ID="LblJDL" runat="server" CssClass=" " Font-Names="Tahoma" 
                                                                    Font-Size="9pt" Height="16px" style="font-size: 9pt" Width="132px">CERTIFICADO 
                                                                DE JUNTA DE LICENCIAMIENTO:</asp:Label>
                                                            </td>
                                                            <td class="style103">
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <asp:TextBox ID="txtTribunalDate" runat="server" Columns="30" CssClass=" " 
                                                                    Font-Names="Tahoma" Font-Size="9pt" Height="18px" IsDate="True" 
                                                                    onclick="ShowDateTimePicker10();" TabIndex="44" Visible="False" Width="79px"></asp:TextBox>
                                                                </td>
                                                            <td class="style109">
														...
														<TR>
															...
															<td class="style16">
                                                                 <%--<asp:TextBox ID="txtTribunalDate" runat="server" Columns="30" CssClass=" " 
                                                                     Font-Names="Tahoma" Font-Size="9pt" Height="18px" IsDate="True" 
                                                                     onclick="ShowDateTimePicker3();" TabIndex="44" Visible="True" Width="79px"></asp:TextBox>--%>
                                                                 <asp:CheckBox ID="chkCannabis" runat="server" AutoPostBack="True" CssClass=" " 
                                                                    oncheckedchanged="RevealControls" Text=" " />
                                                                <asp:Label ID="LblCannabis" runat="server" CssClass=" " Font-Names="Tahoma" 
                                                                    Font-Size="9pt" Height="16px" style="font-size: 9pt" Width="132px">MEDICAL CANNABIS CERTIFICATE</asp:Label>
                                                                 </td>
															<TD class="style103">
                                                                <asp:TextBox ID="txtCannabisDate" runat="server" Columns="30" 
                                                            CssClass=" " Font-Names="Tahoma" Font-Size="9pt" Height="18px" IsDate="True" 
                                                            onclick="ShowDateTimePicker14();" TabIndex="44" Width="79px"></asp:TextBox>
																 </TD>
															<td class="style109">
                                                                <asp:TextBox ID="txtLicencia" runat="server" Columns="30" CssClass=" " 
                                                                    Font-Names="Tahoma" Font-Size="9pt" Height="18px" IsDate="True" 
                                                                     TabIndex="44" Visible="False" Width="79px"></asp:TextBox>
                                                            </td>
															<TD class="style16">
