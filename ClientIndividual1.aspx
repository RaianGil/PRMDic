                                                    ...
                                                    <TD style="FONT-SIZE: 1pt; HEIGHT: 100px" align="center">
                                                        <TABLE id="Table1" style="WIDTH: 100%; HEIGHT: 196px" cellSpacing="0" cellPadding="0" width="803" border="0">
                                                            ...
                                                            <TR rowspan="2">
                                                                ...
                                                                <TD class="style2">
                                                                    <asp:textbox id="txtHomePhone" tabIndex="13" Font-Names="Tahoma" CSSCLASS="form-control telefoneFormat" RUNAT="server" HEIGHT="25px" WIDTH="139px" MAXLENGTH="20" ISDATE="False" Font-Size="9pt"></asp:textbox>
                                                            ...
                                                            <TR>
                                                                ...
                                                                <TD class="style3">
                                                                    <asp:textbox id="txtWorkPhone" tabIndex="13" Font-Names="Tahoma" CSSCLASS="form-control telefoneFormat" RUNAT="server" HEIGHT="25px" WIDTH="139px" MAXLENGTH="20" ISDATE="False" Font-Size="9pt"></asp:textbox>
                                                                ...
                                                                <TD style="WIDTH: 214px; HEIGHT: 15px">
                                                                    <asp:textbox id="txtSocialSecurity" tabIndex="17" HEIGHT="25px" WIDTH="180px" RUNAT="server" Visible="True" CssClass="form-control socialFormat"></asp:textbox>
                                                                </TD>
                                                                <td>
                                                            ...
                                                            <TR>
                                                                ...
                                                                <TD class="style3">
                                                                    <asp:textbox id="TxtCellular" tabIndex="14" Font-Names="Tahoma" CSSCLASS="form-control telefoneFormat" RUNAT="server" HEIGHT="25px" WIDTH="139px" MAXLENGTH="20" ISDATE="False" Font-Size="9pt"></asp:textbox>
                                                                ...
                                                                <TD style="WIDTH: 214px; HEIGHT: 15px">
                                                                    <asp:textbox id="txtEmployerSocSec" tabIndex="20" HEIGHT="25px" WIDTH="180px" RUNAT="server" Visible="True" CssClass="form-control socialFormat"></asp:textbox>
                                                                </TD>
                                                            </TR>
                                                            <tr>
                                                                <td style="height:4px;">
                                                            ...
                                                            <TR>
                                                                ...
                                                                <TD class="style4">
                                                                    <asp:textbox id="txtfax" tabIndex="14" Font-Names="Tahoma" CSSCLASS="form-control telefoneFormat" RUNAT="server" HEIGHT="25px" WIDTH="139px" MAXLENGTH="20" ISDATE="False" Font-Size="9pt"></asp:textbox>
                                                                ...
                                                                <TD style="WIDTH: 214px; HEIGHT: 12px">
																	...
																	HEIGHT="12px" WIDTH="180px" MAXLENGTH="11" MASK="999-99-9999" ISDATE="False" Font-Size="9pt"></maskedinput:maskedtextbox>--%>
                                                                        <asp:dropdownlist id="ddlOriginatedAt" tabIndex="19" Font-Names="Tahoma" CSSCLASS="form-select fs-txt-s" RUNAT="server" HEIGHT="25px" WIDTH="182px"></asp:dropdownlist>
                                                                </TD>
                                                            </TR>
                                                            <tr>
                                                                <td style="height:4px;">
                                                            ...
                                                            <TR>
                                                                ...
                                                                <TD style="WIDTH: 162px; HEIGHT: 11px" align="left">
                                                                    <asp:textbox id="txtBirthdate" tabIndex="6" onclick="ShowDateTimePicker()" Font-Names="Tahoma" CSSCLASS="form-control fechaFormat" RUNAT="server" HEIGHT="25px" WIDTH="114px" Font-Size="9pt"></asp:textbox>
                                                                </TD>
                                                            ...
                                                            <TR>
                                                                ...
                                                                <TD class="style7">
                                                                    <asp:textbox id="txtlicexpdate" tabIndex="16" Font-Names="Tahoma" onclick="ShowDateTimePicker1()" CSSCLASS="form-control fechaFormat" RUNAT="server" HEIGHT="25px" WIDTH="139px" MAXLENGTH="40" Font-Size="9pt"></asp:textbox>
                                                                </TD>
                                                                <TD style="WIDTH: 7px; HEIGHT: 20px"></TD>
                                                                <TD style="WIDTH: 180px; HEIGHT: 15px" align="left">
