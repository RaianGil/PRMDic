...
public partial class Application1 : System.Web.UI.Page
{
    ...
    private bool SaveBeforeRate(bool IsNavigation)
    {
        ...
        try
        {
            ...
            //    //ValidateFields();
            //}
            if (CheckFields() != true && !cp.IsInRole("NOREQUIREDFIELDS"))
            {
        ...
        if (HIPrimeryRateID.Value != "")
        {
            ...
            if (dtPRMEDICRATEPRIMARY2.Rows.Count > 0)
            {
                ...
                for (int i = 0; dtPRMEDICRATEPRIMARY2.Rows.Count > i; i++)
                {
                    ...
                    if (ddlPrimaryLimits1.SelectedItem.Text.Trim() == value.Trim())
                    {
