...
namespace EPolicy
{
    ...
    /// </summary>
    public partial class FirstDollarPolicies : System.Web.UI.Page
    {
        ...
        override protected void OnInit(EventArgs e)
        {
            try
            {
                ...
                if (Session["LookUpTables"] == null)
                {
                    ...
                    DataTable dtPRFirstDollarLimit = LookupTables.LookupTables.GetTable("PRFirstDollarLimit");
                    ...
                    if (taskControl.PRMedicalLimit != null)
                    {
                        ...
                        DataTable dtPRMEDICRATE3 = GetPRMEDICRATEFIRSTDOLLAR(int.Parse(PrimaryID));
                    ...
                    //PRMedicalLimit
                    if (taskControl.PolicyType.Trim() == "PE" || taskControl.PolicyType.Trim() == "AAE")//aqui
                    ...
                    DataTable dtPRPrimaryLimit2 = LookupTables.LookupTables.GetTable("PRFirstDollarLimit");  

                    //PRPrimaryLimit
                    ddlPrMedicalLimits.DataSource = dtPRPrimaryLimit2;
                    ddlPrMedicalLimits.DataTextField = "PRFirstDollarLimitDesc";
                    ddlPrMedicalLimits.DataValueField = "PRFirstDollarLimitID";
                    ddlPrMedicalLimits.DataBind();
                    ddlPrMedicalLimits.SelectedIndex = -1;
                    ddlPrMedicalLimits.Items.Insert(0, "");
                    ...
                    DataTable dtSpecialty = GetPRMEDICRATEFIRSTDOLLAR(int.Parse(dtPRPrimaryLimit.Rows[0]["PRMedicalLimitID"].ToString().Trim()));
        ...
        private void FillGrid()
        {
            try
            {
                ...
                if (taskControl.PolicyType.ToString().Trim().Length >= 3 &&
                    (taskControl.PolicyType.ToString().Trim() != "AAP" && taskControl.PolicyType.ToString().Trim() != "AAE" && taskControl.PolicyType.ToString().Trim() != "IF"))
                    tempPolType = taskControl.PolicyType.Remove(taskControl.PolicyType.IndexOf('T'));
                else
                    tempPolType = taskControl.PolicyType.Trim();
        ...
        private void FillTextControl()
        {
            try
            {
                ...
                if (Session["IsRenewal"] != null && Session["IsRenewal"].ToString() == "Yes")//aqui
                {
                    if (taskControl.CyberEndorsementPremium != 0.00)
                    {
        ...
        protected void btnCancel_Click(object sender, System.EventArgs e)
        {
            ...
            if (taskControl.Mode == 1) //ADD
            {
                if (taskControl.isEndorsement)
                {
                    ...
                    Response.Redirect("FirstDollarPolicies.aspx?" + taskControl.TaskControlID, true);
        ...
        private List<string> PrintCertificate(string certID, int counter, List<string> mergePathsCertificate)
        {
            ...
            try
            {
                ...
                if (In == "1")
                {
                    ...
                    if (taskControl.PolicyType.Trim() == "IF")
                    {
                    ...
                    if (taskControl.PolicyType.ToString().Trim() == "PP" || taskControl.PolicyType.ToString().Trim() == "PE" || taskControl.PolicyType.ToString().Trim() == "AAP" || taskControl.PolicyType.ToString().Trim() == "AAE" || taskControl.PolicyType.ToString().Trim() == "IF")
                    ...
                    #region Gap Dates
                    if (taskControl.PolicyType.Trim() == "PP" || taskControl.PolicyType.Trim() == "PE" || taskControl.PolicyType.Trim() == "PPT" || taskControl.PolicyType.Trim() == "PET" || taskControl.PolicyType.Trim() == "AAP" || taskControl.PolicyType.Trim() == "AAPT" || taskControl.PolicyType.Trim() == "PAH" || taskControl.PolicyType.Trim() == "IF")
                    {
        ...
        protected void btnPrintPolicy_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                else if (taskControl.PolicyType.Trim() == "IF")// || taskControl.PolicyType.Trim() == "PE")
                {
                    if (taskControl.Anniversary == "01")
                    {
                    ...
                    else //Renovacion.
                    {
                        ...
                        if (!taskControl.PrintPolicy) //Proof that the renovation was printed.
                        {
                            ...
                            if (taskControl.PolicyType.ToString().Trim() == "IF")
                ...
                else if (taskControl.PolicyType.Trim() == "IFT")
                {
                    #region Primary Tail
                    DataDynamics.ActiveReports.ActiveReport3 rpt = null;
        ...
        private List<string> PrintCertificateReports(string certID, int counter, List<string> mergePaths)
        {
            ...
            try
            {
                ...
                if (taskControl.PolicyType.Trim() == "IF" || taskControl.PolicyType.Trim() == "IFT")
                {
                    ReportPath = "Reports/FirstDollarPolicyCertificate.rdlc";
                }
        ...
        protected void btnPrintPolicyWord_Click(object sender, System.EventArgs e)
        {
            ...
            {
                if (taskControl.PolicyType == "APP" || taskControl.PolicyType == "AEE")
                {
                    Print();
                }
                else
            ...
            try
            {
                ...
                for (int i = 0; i < reports.Rows.Count; i++)
                {
                    if (reports.Rows[i]["WordDocument"].ToString().Contains(".pdf"))
                    {
                        ...
                        string fullFilePath = currentApplicationPath + "Reports\\Word\\Files\\FirstDollar\\" + reports.Rows[i]["WordDocument"].ToString();
                ...
                if (IncludeCert == true && taskControl.PolicyType.Trim() == "PP" || taskControl.PolicyType.Trim() == "CP" || taskControl.PolicyType.Trim() == "IF")
                {
        ...
        {
            PrintWord("PolicyType = 'IF' and FormName = 'eMed Defense Cyber Endorsement'", false);
        }
        ...
        protected void btnCancellation_Click(object sender, System.EventArgs e)
        {
            ...
            {
                RemoveSessionLookUp();
                Session.Add("FromUI", "FirstDollarPolicies.aspx");
        ...
        protected void btnHistory_Click(object sender, System.EventArgs e)
        {
            if (Session["TaskControl"] != null)
            {
                RemoveSessionLookUp();
                TaskControl.Policies taskControl = (TaskControl.Policies)Session["TaskControl"];
                Response.Redirect("SearchAuditItems.aspx?type=33&taskControlID=" +
                    ...
                    switch (int.Parse(ddlPolicyClass.SelectedItem.Value))
                    {
                        ...
                        case 13: //Etch
                            ...
                            if (taskControl.Mode == 1)
                            {
                                ...
                                taskControl.Status = "Inforce";
                                taskControl.TaskStatusID = 23; // int.Parse(LookupTables.LookupTables.GetID("TaskStatus", "Open"));
                                taskControl.TaskControlTypeID = 26; //int.Parse(LookupTables.LookupTables.GetID("TaskControlType", "Policies"));
                                taskControl.CommissionAgencyPercent = "0";
                                //taskControl.TotalPremium     = 0.00; //Ya viene del quote.
                                //taskControl.NewUse			 = 2; //Ya viene del quote.
                                taskControl.AutoAssignPolicy = false; //Para que en VSC aparesca puedan entrar el num de pol manualmente.
        ...
        protected void btnNew_Click(object sender, System.EventArgs e)
        {
            ...
            Session.Add("TaskControl", taskControl);
            Response.Redirect("FirstDollarPolicies.aspx", false);
        }
        ...
        private void SetDDLLimit(int LimitID)
        {
            ...
            dtPRMEDICRATE2 = GetPRMEDICRATEFIRSTDOLLAR(LimitID);
            ...
            DataTable dtPRMEDICRATEPRIMARY = GetPRMEDICRATEFIRSTDOLLARBYISOCODE(taskControl.PRMedicRATEID, taskControl.IsoCode);
                ddlRate.SelectedIndex = ddlRate.Items.IndexOf(
        ...
        private void Recalculate()
        {
            try
            {
                ...
                if (taskControl.PolicyType.Trim() == "PE" || taskControl.PolicyType.Trim() == "AAE")
                    ...
                    dtPRMEDICRATE2 = GetPRMEDICRATEFIRSTDOLLARBYISOCODEDDL(int.Parse(ddlPrMedicalLimits.SelectedItem.Value.ToString().Trim()), txtIsoCode.Text.Trim()); 
                else
                    ...
                    dtPRMEDICRATEPRIMARY2 = GetPRMEDICRATEFIRSTDOLLARBYISOCODEDDL(int.Parse(ddlPrMedicalLimits.SelectedItem.Value.ToString().Trim()), txtIsoCode.Text.Trim());
        ...
        protected void ddlRate_SelectedIndexChanged(object sender, EventArgs e)
        {
           ...
           // DataTable dtPRMEDICRATEPRIMARY = EPolicy.TaskControl.Application.GetPRMEDICRATEPRIMARYAHCBYISOCODE(int.Parse(ddlRate.SelectedItem.Value.Trim()), dtIsoCode.Rows[0]["IsoCode"].ToString());
            DataTable dtPRMEDICRATEPRIMARY = GetPRMEDICRATEFIRSTDOLLARBYISOCODE(int.Parse(ddlRate.SelectedItem.Value.Trim()), dtIsoCode.Rows[0]["IsoCode"].ToString());
            if (taskControl.PRMedicRATEID != 0)
            {
        ...
        protected void ddlRate_SelectedIndexChanged2(object sender, EventArgs e)
        {
            ...
            dtPRMEDICRATE2 = GetPRMEDICRATEFIRSTDOLLAR(int.Parse(ddlPrMedicalLimits.SelectedItem.Value.Trim()));
            ddlRate.Items.Clear();
            ddlRate.DataSource = dtPRMEDICRATE2;
            ddlRate.DataTextField = "PRMEDICRATEDesc";
            ddlRate.DataValueField = "PRMEDICRATEID";
        ...
        private void GetOthersRates()
        {
            ...
            try
            {
                if (ddlPrMedicalLimits.SelectedItem.Value != null)
                {
                    if (ddlPrMedicalLimits.SelectedItem.Value.Trim() != "")
                    {
                        //Primary
                        DataTable dt1 = GetPRMEDICEFIRSTDOLLARByClassAndLimitID("1", int.Parse(taskControl.PRMedicalLimit.ToString()));
                        DataTable dt2 = GetPRMEDICEFIRSTDOLLARByClassAndLimitID("7", int.Parse(taskControl.PRMedicalLimit.ToString()));
                        ...
                        //Excess
                        DataTable dt4 = GetPRMEDICEFIRSTDOLLARByClassAndLimitID("1", int.Parse(taskControl.PRMedicalLimit.ToString()));
                        DataTable dt5 = GetPRMEDICEFIRSTDOLLARByClassAndLimitID("7", int.Parse(taskControl.PRMedicalLimit.ToString()));
                        DataTable dt6 = GetPRMEDICEFIRSTDOLLARByClassAndLimitID("3A", int.Parse(taskControl.PRMedicalLimit.ToString()));
        ...
        private List<string> PrintMSWord(string Filename, List<string> mergePaths, string ProcessedPath)
        {
            ...
            string FilePath = @"C:\inetpub\wwwroot\PRMdic\Reports\Word\Files\FirstDollar\" + Filename;
        ...
        private string GetBookMarkValue(string BookMarkName)
        {
            ...
            string value = "";
            string Limit1 = "";
            if (ddlPrMedicalLimits.SelectedItem.Text.Trim() != "")
            {
                Limit1 = ddlPrMedicalLimits.SelectedItem.Text.Trim();
            }
            else { Limit1 = "1,000,000/3,000,000"; }
        ...
        private static DataTable GetPRMEDICRATEFIRSTDOLLARBYISOCODE(int prmedicrateid, string Isocode2)
        {
            DbRequestXmlCookRequestItem[] cookItems =
                new DbRequestXmlCookRequestItem[2];
            ...
            DbRequestXmlCooker.AttachCookItem("Isocode2",
                SqlDbType.VarChar, 50, Isocode2.ToString(),
                ref cookItems);
         ...
         public static DataTable GetPRMEDICRATEFIRSTDOLLARBYISOCODEDDL(int prmedicallimitid ,string Isocode2)
        {
            DbRequestXmlCookRequestItem[] cookItems =
            new DbRequestXmlCookRequestItem[2];
           ...
           ref cookItems);
            ...
            try
            {
                dt = exec.GetQuery("GetPRMEDICRATEFIRSTDOLLARBYISOCODEDDL", xmlDoc);
        ...
        private static DataTable GetPRMEDICRATEFIRSTDOLLAR(int PRMedicalLimitID)
        {
            DbRequestXmlCookRequestItem[] cookItems =
            new DbRequestXmlCookRequestItem[1];
            ...
            try
            {
                dt = exec.GetQuery("GetPRMEDICRATEFIRSTDOLLAR", xmlDoc);
        ...
        private static DataTable GetPRMEDICEFIRSTDOLLARByClassAndLimitID(string Class, int prmedicallimitid)
        {
            DbRequestXmlCookRequestItem[] cookItems =
            new DbRequestXmlCookRequestItem[2];

            DbRequestXmlCooker.AttachCookItem("class",
            SqlDbType.VarChar, 5, Class.ToString(),
            ref cookItems);
            ...
            try
            {
                dt = exec.GetQuery("GetPRMEDICEFIRSTDOLLARByClassAndLimitID", xmlDoc);
