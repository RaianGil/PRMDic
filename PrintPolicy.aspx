                      ...
                      <div class="row">
                        <div class="col-md-6">
						    <asp:Label id="Label17" runat="server" CssClass="headForm1 " Height="16px" Width="212px" Font-Names="Tahoma"
						    	Font-Size="11pt" ForeColor="Black" Font-Bold="True">Print Policy:</asp:Label>
                        ...
                        <div class="col-md-6">
			    			...
			    			<asp:label id="lblParentCustomer" Font-Names="Tahoma" RUNAT="server" CSSCLASS="headfield1"
			    				WIDTH="96px" Font-Size="9pt"></asp:label>
                        </div>                      
                      </div>
                   </div>
                   <div class="col-md-8" style="text-align:right;">                   
                        <asp:Button ID="btnSign" runat="server" style="margin-bottom: 4px" CssClass="btn-bg-theme1 btn-w-100 btn-r-4" BorderColor="#400000"
                            BorderWidth="0px" Font-Size="9pt" Font-Names="Tahoma" ForeColor="White" OnClick="btnSign_Click" TabIndex="45" Text="Sign"/>
						<asp:Button id="PrintPolicies" runat="server" BorderWidth="0px" BorderColor="#400000" style="margin-bottom: 4px" CssClass="btn-bg-theme1 btn-w-100 btn-r-4"
							Text="Print" Font-Names="Tahoma" Font-Size="9pt" ForeColor="White" onclick="PrintPolicies_Click"></asp:Button>
						<asp:Button id="BtnBack" runat="server" BorderWidth="0px" BorderColor="#400000" style="margin-bottom: 4px" CssClass="btn-bg-theme1 btn-w-100 btn-r-4"
							Text="Exit" Font-Names="Tahoma" Font-Size="9pt" ForeColor="White" onclick="BtnBack_Click"></asp:Button> 
                   </div>
                   <div class="col-md-12">
                   <hr />
                    <div class="row">
                        <div class="col-md-7">
						    <asp:label id="Label4" runat="server" Width="127px" CssClass="headform1" Font-Names="Tahoma"
						    	Font-Size="9pt" ForeColor="Black">Policy & Document List</asp:label>
							<p>
                                <asp:CheckBoxList id="ChkPolicyList" runat="server" CssClass="form-control" RepeatLayout="Flow" BorderStyle="Solid"
							    	BorderWidth="1px" Height="353px" Font-Names="Tahoma" Font-Size="9pt"></asp:CheckBoxList>
                            </p>
                        </div>
                        <div class="col-md-5">
                            <div class="row">
                                <div class="col-md-12">
								    <asp:label id="Label9" runat="server" Width="60px" CssClass="headform1" Font-Names="Tahoma"
								    	Font-Size="9pt" ForeColor="Black">Copy List:</asp:label>
									<P>
										<asp:CheckBoxList id="ChkCopyList" runat="server" CssClass="form-control" RepeatLayout="Flow" BorderStyle="Solid"
											BorderWidth="1px" Height="161px" Font-Names="Tahoma" Font-Size="9pt"></asp:CheckBoxList></P>
									<P>
                                </div>
                                <div class="col-md-12">
								    <asp:label id="Label1" runat="server" Width="60px" CssClass="headform1" Font-Names="Tahoma"
								    	Font-Size="9pt" ForeColor="Black">Print Only One Copy of:</asp:label>
								    <p>
                                        <asp:CheckBoxList id="ChkPrintJustOne" runat="server" Height="161px"
								        	BorderWidth="1px" BorderStyle="Solid" RepeatLayout="Flow" CssClass="form-control" Font-Names="Tahoma"
								        	Font-Size="9pt"></asp:CheckBoxList>
                                    </P>
                                </div>
                            </div>
                        </div>
