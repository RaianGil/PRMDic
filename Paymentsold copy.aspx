											...
											<TR>
												...
												<TD align="right">
													<asp:Button id="btnAuditTrail" runat="server" Height="23px" Text="History" BorderWidth="0px"
														...
														Width="60px" onclick="Button3_Click" Visible="False" style="margin-right: 1px"></asp:Button>
													<asp:Button id="btnDelete" runat="server" Height="23px" Width="60px" 
                                                        Text="Delete" BorderWidth="0px"
														BorderColor="#400000" BackColor="#400000" ForeColor="White" Font-Names="Tahoma" onclick="BtnDele_Click" 
                                                        Visible="False" style="margin-right: 1px"></asp:Button>
													<asp:Button id="btnReceipt" runat="server" Height="23px" Width="60px" 
                                                        Text="Receipt" BorderWidth="0px"
														BorderColor="#400000" BackColor="#400000" ForeColor="White" Font-Names="Tahoma" onclick="btnReceipt_Click" 
                                                        style="margin-right: 1px"></asp:Button>
													<asp:Button id="BtnSave" runat="server" Height="23px" Width="60px" Text="Save" BorderWidth="0px"
														BorderColor="#400000" BackColor="#400000" ForeColor="White" Font-Names="Tahoma" onclick="Button6_Click"  
                                                        style="margin-right: 1px"></asp:Button>
													<asp:Button id="btnCancel" runat="server" Height="23px" Text="Cancel" 
                                                        BorderWidth="0px" BorderColor="#400000"
														BackColor="#400000" ForeColor="White" Font-Names="Tahoma" Width="60px" onclick="Button5_Click" 
                                                        style="margin-right: 1px"></asp:Button>
													<asp:Button id="btnEdit" runat="server" Height="23px" Width="60px" Text="Edit" BorderWidth="0px"
														BorderColor="#400000" BackColor="#400000" ForeColor="White" Font-Names="Tahoma" onclick="Button4_Click" 
                                                        style="margin-right: 1px"></asp:Button>
													<asp:Button id="btnBack" runat="server" Height="23px" Text="Back" 
                                                        BorderWidth="0px" BorderColor="#400000"
														BackColor="#400000" ForeColor="White" Font-Names="Tahoma" Width="60px" onclick="Button5_Click" 
                                                        style="margin-right: 1px"></asp:Button>
													<asp:Button id="BtnExit" runat="server" Height="23px" Width="60px" Text="Exit" BorderWidth="0px"
														BorderColor="#400000" BackColor="#400000" ForeColor="White" Font-Names="Tahoma" onclick="Button2_Click" 
                                                        style="margin-right: 1px"></asp:Button> 
												</TD>
											</TR>
										</TABLE>
													...
													<TABLE id="Table1" style="WIDTH: 806px; HEIGHT: 234px" cellSpacing="0" cellPadding="0"
														...
														<TR>
															...
															<TD style="WIDTH: 67px; HEIGHT: 1px">
																<asp:label id="Label2" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
															...
															<TD style="WIDTH: 178px; HEIGHT: 1px" align="left">
																<asp:dropdownlist id="ddlPolicyClass" tabIndex="1" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" HEIGHT="21px" WIDTH="169" onselectedindexchanged="ddlPolicyClass_SelectedIndexChanged"></asp:dropdownlist></TD>
															<TD style="WIDTH: 135px; HEIGHT: 1px"> 
																<asp:label id="Label1" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18px" WIDTH="76px">Customer No.</asp:label></TD>
															<TD class="style1">
																<asp:textbox id="TxtCustomerNo" tabIndex="9" Font-Size="9pt" Font-Names="Tahoma"  
														...
														<TR>
															...
															<TD style="WIDTH: 178px; HEIGHT: 15px" align="left">
																<asp:textbox id="TxtPolicyType" tabIndex="3" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD class="style2">
																<asp:textbox id="TxtName" tabIndex="10" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD style="WIDTH: 240px; HEIGHT: 15px">
																<asp:label id="Label5" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18" WIDTH="47px">Aging</asp:label></TD>
															<TD style="WIDTH: 14px; HEIGHT: 15px">
																<asp:textbox id="TxtAging" tabIndex="15" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" HEIGHT="19px" WIDTH="171px" MAXLENGTH="50"></asp:textbox></TD>
														</TR>
														<TR>
															<TD style="WIDTH: 8px; HEIGHT: 15px"></TD>
															<TD style="WIDTH: 67px; HEIGHT: 15px">
																<asp:label id="lblLastName2" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	WIDTH="92px" HEIGHT="2px" ENABLEVIEWSTATE="False">Policy No.</asp:label></TD>
															<TD style="WIDTH: 33px; HEIGHT: 15px" align="left"></TD>
															<TD style="WIDTH: 178px; HEIGHT: 15px" align="left">
																<asp:textbox id="txtPolicyNo" tabIndex="4" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD style="WIDTH: 135px; HEIGHT: 15px"> 
																<asp:label id="lblHouseIncome" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	WIDTH="105px" HEIGHT="17px">Last Name1</asp:label></TD>
															<TD class="style2">
																<asp:textbox id="TxtLastName1" tabIndex="11" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" WIDTH="139px" HEIGHT="19px" MAXLENGTH="15"></asp:textbox></TD>
															<TD style="WIDTH: 6px; HEIGHT: 15px"></TD>
															<TD style="WIDTH: 240px; HEIGHT: 15px">
																<asp:label id="Label3" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18" WIDTH="60px">Entry Date</asp:label></TD>
															<TD style="WIDTH: 14px; HEIGHT: 15px">
																<asp:textbox id="TxtEntryDate" tabIndex="16" Font-Size="9pt" Font-Names="Tahoma"  
														...
														<TR>
															...
															<TD style="WIDTH: 67px; HEIGHT: 14px">
																<asp:label id="lblBirthdate" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
															...
															<TD style="WIDTH: 178px; HEIGHT: 14px" align="left">
																<asp:textbox id="txtCertificate" tabIndex="5" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD style="WIDTH: 135px; HEIGHT: 14px"> 
																<asp:label id="Label6" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	WIDTH="74px" HEIGHT="17px">Last Name 2</asp:label></TD>
															<TD class="style3">
																<asp:textbox id="TxtLastName2" tabIndex="12" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD style="WIDTH: 240px; HEIGHT: 14px">
																<asp:label id="Label9" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18" WIDTH="72px">Close Date</asp:label></TD>
															<TD style="WIDTH: 14px; HEIGHT: 14px">
																<asp:textbox id="TxtCloseDate" tabIndex="17" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" HEIGHT="19px" WIDTH="171px" MAXLENGTH="50"></asp:textbox></TD>
														</TR>
														<TR>
															<TD style="WIDTH: 8px; HEIGHT: 11px"></TD>
															<TD style="WIDTH: 67px; HEIGHT: 11px">
																<asp:label id="Label4" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
															...
															<TD style="WIDTH: 178px; HEIGHT: 11px">
																<asp:textbox id="TxtSuffix" tabIndex="6" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD style="WIDTH: 135px; HEIGHT: 11px"> 
																<asp:label id="Label7" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	WIDTH="88px" HEIGHT="17px">Social Security</asp:label></TD>
															<TD class="style4">
																<asp:textbox id="TxtSocialSecurity" tabIndex="13" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" HEIGHT="19px" WIDTH="139px" MAXLENGTH="15"></asp:textbox></TD>
															<TD style="WIDTH: 6px; HEIGHT: 11px"></TD>
															<TD style="WIDTH: 240px; HEIGHT: 11px">
																<asp:label id="LblBank" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="7px" WIDTH="26px">Bank</asp:label></TD>
															<TD style="WIDTH: 14px; HEIGHT: 11px">
																<asp:dropdownlist id="ddlBank" tabIndex="18" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" HEIGHT="19px" WIDTH="172px"></asp:dropdownlist></TD>
														</TR>
														<TR>
															<TD style="WIDTH: 8px; HEIGHT: 1px"></TD>
															<TD style="WIDTH: 67px; HEIGHT: 1px">
																<asp:label id="lblMaritalStatus" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" WIDTH="92px" HEIGHT="1px" ENABLEVIEWSTATE="False">Loan No.</asp:label></TD>
															<TD style="WIDTH: 33px; HEIGHT: 1px" align="left"></TD>
															<TD style="WIDTH: 178px; HEIGHT: 1px" align="left">
																<asp:textbox id="TxtLoanNo" tabIndex="7" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD style="WIDTH: 240px; HEIGHT: 1px" align="left">
																<asp:label id="Label13" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="7px" WIDTH="70px">Receipt No.</asp:label></TD>
															<TD style="WIDTH: 14px; HEIGHT: 1px" align="left">
																<asp:textbox id="TxtReceiptNo" tabIndex="15" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" HEIGHT="19px" WIDTH="171px" MAXLENGTH="50"></asp:textbox></TD>
														</TR>
														<TR>
															...
															<TD style="WIDTH: 135px; HEIGHT: 10px">
																<asp:label id="lblLastName1" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	WIDTH="102px" HEIGHT="2px" ENABLEVIEWSTATE="False" Visible="False">Ins. Co. Policy No.</asp:label></TD>
															<TD class="style5">
																<asp:textbox id="txtOriginalPolicyNo" tabIndex="2" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD style="WIDTH: 240px; HEIGHT: 10px">
																<asp:label id="Label16" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="7px" WIDTH="72px">Authorize By</asp:label></TD>
															<TD style="WIDTH: 14px; HEIGHT: 10px">
																<asp:textbox id="TxtAuthorizeBy" tabIndex="15" Font-Size="9pt" Font-Names="Tahoma"  
														...
														<TR>
															...
															<TD style="WIDTH: 67px; HEIGHT: 18px">
																<asp:label id="lblComments" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
															...
															<TD style="WIDTH: 178px; HEIGHT: 18px">
																<asp:textbox id="txtComments" tabIndex="8" Font-Size="9pt" Font-Names="Tahoma"  
								...
								<TR>
									<TD style="FONT-SIZE: 0pt; WIDTH: 35px; HEIGHT: 25px">
										<TABLE id="Table3" style="WIDTH: 814px; HEIGHT: 76px" cellSpacing="1" cellPadding="1" width="814"
											border="0">
											<TR>
												<TD style="FONT-SIZE: 1pt" align="center" valign="bottom">
													<TABLE id="Table4" style="WIDTH: 809px; HEIGHT: 88px" cellSpacing="0" cellPadding="0" width="809"
														...
														<TR>
															...
															<TD style="WIDTH: 50px">
																<asp:textbox id="TxtCheckNo" tabIndex="20" Font-Size="9pt" Font-Names="Tahoma"  
															...
															<TD style="WIDTH: 69px">
																<maskedinput:maskedtextbox id="TxtTotalAmount" tabIndex="21" runat="server" Font-Size="9pt" Font-Names="Tahoma"
																	  Width="89px" Height="19px" IsCurrency="True"></maskedinput:maskedtextbox></TD>
															<TD></TD>
														</TR>
														<TR>
														...
														<TR>
															<TD style="WIDTH: 71px" align="center">
																<asp:label id="Label11" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18" WIDTH="10px">SRO</asp:label></TD>
															<TD style="WIDTH: 118px" align="center">
																<asp:label id="LblPaymentDate" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18" WIDTH="107px">Payment Date</asp:label></TD>
															<TD align="center">
																<asp:label id="Label17" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18" WIDTH="94px">Payment Check</asp:label></TD>
															<TD style="WIDTH: 121px" align="center">
																<asp:label id="Label18" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18" WIDTH="101px">Payment Amount</asp:label></TD>
															<TD align="center" valign="top">
																<asp:label id="Label14" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	ENABLEVIEWSTATE="False" HEIGHT="18px" WIDTH="144px">Name</asp:label></TD>
															<TD style="WIDTH: 69px" align="center">
																<asp:label id="Label19" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	WIDTH="87px" HEIGHT="18" ENABLEVIEWSTATE="False">Debit / Credit</asp:label></TD>
															<TD align="center">
																<asp:label id="Label20" Font-Size="9pt" Font-Names="Tahoma"   RUNAT="server"
																	WIDTH="77px" HEIGHT="18" ENABLEVIEWSTATE="False"> Deposit Date</asp:label></TD>
														</TR>
														<TR>
															<TD style="WIDTH: 71px" align="center">
																<asp:checkbox id="ChkSRO" tabIndex="21" runat="server"   Width="16px" Text=" "
																	AutoPostBack="True" oncheckedchanged="ChkSRO_CheckedChanged"></asp:checkbox></TD>
															<TD style="WIDTH: 118px" align="center">
																<asp:TextBox id="TxtPaymentDate" tabIndex="22" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" HEIGHT="19px" WIDTH="82px" ISDATE="True"></asp:TextBox><INPUT id="btnCalendar" style="WIDTH: 21px; HEIGHT: 21px" onclick="javascript:calendar_window=window.open('selectDate.aspx?formname=document.Paym.TxtPaymentDate','calendar_window','width=250,height=250');calendar_window.focus()"
																	tabIndex="23" type="button" value="..." name="btnCalendar" RUNAT="server"></TD>
															<TD align="center">
																<asp:Textbox id="TxtPaymentCheck" tabIndex="24" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" HEIGHT="19px" WIDTH="111px" MAXLENGTH="50"></asp:Textbox></TD>
															<TD style="WIDTH: 121px" align="center">
																<asp:TextBox id="TxtPaymentAmount" tabIndex="25" runat="server" Font-Size="9pt" Font-Names="Tahoma"
																	  Width="94px" Height="19px" IsCurrency="True"></asp:TextBox></TD>
															<TD align="center" valign="top">
																<asp:TextBox ID="TxtNamePayee" runat="server" Height="19px" 
                                                                     Width="125px" style="margin-left: 1px; margin-right: 1px" TabIndex="26"></asp:TextBox>
                                                            </TD>
															<TD style="WIDTH: 69px" align="center">
																<asp:dropdownlist id="ddlCreditDebit" tabIndex="27" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" WIDTH="85px" HEIGHT="21px" AutoPostBack="True" style="margin-left: 1px; margin-right: 1px"></asp:dropdownlist></TD>
															<TD>
																<asp:TextBox id="txtDepositDate" tabIndex="28" Font-Size="9pt" Font-Names="Tahoma"  
																	RUNAT="server" WIDTH="102px" HEIGHT="19px" ISDATE="True"></asp:TextBox>
