...
{
    /// <summary>
    /// Summary description for E_116New.
    /// </summary>
    public partial class E_116New : DataDynamics.ActiveReports.ActiveReport3
    {

        private EPolicy.TaskControl.Policy _taskcontrol;

        public E_116New(EPolicy.TaskControl.Policy taskcontrol)
        {
            //
        ...
        private void E_116_New_ReportStart(object sender, EventArgs e)
        {
