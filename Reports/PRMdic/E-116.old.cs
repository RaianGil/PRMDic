...
namespace EPolicy2.Reports.PRMdic
{
    ...
    /// </summary>
    public partial class E_116 : DataDynamics.ActiveReports.ActiveReport3
    {
        private EPolicy.TaskControl.Policy _taskcontrol;

        public E_116(EPolicy.TaskControl.Policy taskcontrol)
        {
            //
        ...
        private void E_116_ReportStart(object sender, EventArgs e)
        {
            txtPolicyNo.Text = _taskcontrol.PolicyType.Trim() + '-' + _taskcontrol.PolicyNo.Trim();
