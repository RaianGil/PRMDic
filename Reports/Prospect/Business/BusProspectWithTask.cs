...
{
	public class BusProspectWithTask : DataDynamics.ActiveReports.ActiveReport3
	{
		string _FromDate;
		string _ToDate;

		public BusProspectWithTask(string FromDate,string ToDate)
		{
			_FromDate = FromDate;
			_ToDate = ToDate;
		...
		private void BusProspectWithTask_ReportStart(object sender, System.EventArgs eArgs)
		{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BusProspectWithTask));
            ...
            this.lblCriterias.Text = "Prospects (Business) With Tasks";
            ...
            this.TextBox26.DataField = "BusinessName";
            ...
            this.TextBox26.Width = 2.114583F;
            // 
            // TextBox5
            // 
			...
			this.ReportStart += new System.EventHandler(this.BusProspectWithTask_ReportStart);
