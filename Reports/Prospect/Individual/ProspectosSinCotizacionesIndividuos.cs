...
{
	public class ProspectosSinCotizacionesIndividuos : DataDynamics.ActiveReports.ActiveReport3
	{
		string _FromDate;
		string _ToDate;
		
		public ProspectosSinCotizacionesIndividuos(string FromDate,string ToDate)
		{
			_FromDate = FromDate;
			_ToDate = ToDate;
		...
		private void ProspectosSinCotizacionesIndividuos_ReportStart(object sender, System.EventArgs eArgs)
		{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProspectosSinCotizacionesIndividuos));
            ...
            this.lblCriterias.Text = "Prospect (Individual) Whithout Quotes";
			...
			this.ReportStart += new System.EventHandler(this.ProspectosSinCotizacionesIndividuos_ReportStart);
