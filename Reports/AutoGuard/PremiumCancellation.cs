...
{
    public partial class PremiumCancellation : DataDynamics.ActiveReports.ActiveReport3
    {
        string _FromDate;
        string _ToDate;
        string _ReportType;
        ...
        public PremiumCancellation(string FromDate, string ToDate, string ReportType, bool Summary, string mHeadCompany)
        {
            _FromDate = FromDate;
            _ToDate = ToDate;
        ...
        private void PremiumCancellation_ReportStart(object sender, EventArgs e)
        {
            if (_Summary)
            {
