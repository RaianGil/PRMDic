...
{
    /// <summary>
    /// Summary description for EtchBreakdown.
    /// </summary>
    public partial class EtchBreakdown : DataDynamics.ActiveReports.ActiveReport3
    {
        string _FromDate;
        string _ToDate;
        string _ReportType;
        ...
        public EtchBreakdown(string FromDate, string ToDate, string ReportType, bool Summary, string mHeadCompany)
        {
            _FromDate = FromDate;
            _ToDate = ToDate;
        ...
        private void EtchBreakdown_ReportStart(object sender, EventArgs e)
        {
