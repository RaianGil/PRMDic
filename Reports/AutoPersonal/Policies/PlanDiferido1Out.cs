...
{
    public partial class PlanDiferido1Out : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public PlanDiferido1Out(EPolicy.TaskControl.Policy taskcontrol,  EPolicy.TaskControl.DeferredPayment _deferredPayment, string copyValue)
        {
            _policy = taskcontrol;
        ...
        private void PlanDiferido1Out_ReportStart(object sender, EventArgs e)
        {
