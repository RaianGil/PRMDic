...
{
    public partial class PlanDiferido1 : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public PlanDiferido1(EPolicy.TaskControl.Policy taskcontrol, string copyValue)
        {
            _policy = taskcontrol;
        ...
        private void PlanDiferido1_ReportStart(object sender, EventArgs e)
        {
