...
namespace EPolicy2.Reports
{
    ...
    /// </summary>
    public partial class PlanDiferido2 : DataDynamics.ActiveReports.ActiveReport3
    {
        private string _CopyValue;
        //private EPolicy.TaskControl.QuoteAuto _policy;
        private EPolicy.TaskControl.Policy _policy;

        public PlanDiferido2(EPolicy.TaskControl.Policy taskcontrol, string copyValue)
        {
            _policy = taskcontrol;
        ...
        private void PlanDiferido2_ReportStart(object sender, EventArgs e)
        {
