             ...
             <div class="col-md-8" style="text-align:right;">
                ...
                <asp:button id="btnPolicyCert" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" 
                    Text="Policy Cert." style="margin-bottom: 4px;" onclick="btnPolicyCert_Click" Visible="False"></asp:button>
                                         ...
                                         <div class="col-md-12">
                                <div class="row">
                                    <div id="effect" class="col-md-4 ui-widget-header ui-corner-all f-center" aling="right" style="background:BB1509;width: 375px; height:250px; display:none">    <%--position:absolute;--%>
                                        <div class="col-md-4">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-12" style="height:29.2px;">
                                    ...
                                    <div>
                                      <asp:TextBox id="txtPriPolEffecDate1" Height="29.2px" Font-Size="8pt" Font-Names="Tahoma"
                                        RUNAT="server" ISDATE="True" CssClass="form-control" onclick="ShowDateTimePicker3();"></asp:TextBox>
             ...
             <hr />
              <div class="row" >
                  ...
                  <div class="col-md-12">
                     ...
                     <asp:DataGrid ID="dtEndorsement" runat="server" AllowPaging="True" AlternatingItemStyle-BackColor="#BB1509" AlternatingItemStyle-CssClass="HeadForm3" AutoGenerateColumns="False" BackColor="White" BorderColor="#D6E3EA" CellPadding="0" HeaderStyle-BackColor="#5C8BAE" HeaderStyle-ForeColor="White"
                         HeaderStyle- HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="HeadForm3" ItemStyle-HorizontalAlign="center" OnItemCommand="dtEndorsement_ItemCommand" PageSize="8" TabIndex="9" Width="90%">
                         <FooterStyle BackColor="Navy" ForeColor="#003399" />
