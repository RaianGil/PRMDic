<%@ Register TagPrefix="MaskedInput" Namespace="MaskedInput" Assembly="MaskedInput" %>
    <%@ Page language="c#" AutoEventWireup="true" Inherits="EPolicy.Policies" CodeFile="Policies.aspx.cs" %>
                    ...
                    <div class="container-xl mb-4" style="padding-left:18px; padding-right:18px;">
                        <div class="row">
                            ...
                            <div class="col-md-8" style="text-align:right;">
                                <asp:Button ID="btnComments" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Comments" style="margin-bottom: 4px;" onclick="btnComments_Click1" />
                                <asp:Button ID="btnRate" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Rate" style="margin-bottom: 4px;" />
                                <asp:button id="btnPrintPolicy" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Print" style="margin-bottom: 4px;" onclick="btnPrintPolicyWord_Click" />
                                <asp:button id="btnEnablePrint" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Enable Print" style="margin-bottom: 4px;" onclick="btnEnablePrint_Click" onclientclick="return confirm('Enabling Policy Printing, Continue?');" Visible="False"
                                />
                                <asp:button id="btnCancellation" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Cancellation" style="margin-bottom: 4px;" onclick="btnCancellation_Click" />
                                <asp:Button ID="btnRenew" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" OnClick="btnRenew_Click" style="margin-bottom: 4px;" Text="Renew" />
                                <asp:button id="btnReinstatement" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Reinstatement" style="margin-bottom: 4px;" onclick="btnReinstatement_Click"></asp:button>
                                <asp:button id="BtnSave" runat="server" Text="Save" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" onclick="BtnSave_Click" style="margin-bottom: 4px;"></asp:button>
                                <asp:button id="btnAdd2" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Add" style="margin-bottom: 4px;" onclick="btnAdd2_Click" Visible="False"></asp:button>
                                <asp:button id="btnDelete" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Delete" style="margin-bottom: 4px;" onclick="btnDelete_Click" onclientclick="return confirm('Are you certain you want to delete this Policy?');"></asp:button>
                                <asp:button id="btnEdit" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Modify" style="margin-bottom: 4px;" onclick="btnEdit_Click"></asp:button>
                                <asp:button id="btnCancel" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Cancel" style="margin-bottom: 4px;" onclick="btnCancel_Click"></asp:button>
                                <asp:button id="BtnExit" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Exit" style="margin-bottom: 4px;" onclick="BtnExit_Click"></asp:button>
                                <asp:Button ID="btnHistory" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" OnClick="btnHistory_Click" style="margin-bottom: 4px;" Text="History" />
                                <asp:button id="btnEndor" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="New Endorsement" style="margin-bottom: 4px;" onclick="btnEndor_Click"></asp:button>
                                <asp:button id="btnComissions" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Commissions" style="margin-bottom: 4px;" onclick="btnComissions_Click"></asp:button>
                                <asp:button id="btnPayments" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Payments" style="margin-bottom: 4px;" onclick="btnPayments_Click"></asp:button>
                                <asp:button id="btnFinancialCanc" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Financial Canc." style="margin-bottom: 4px;" onclick="btnFinancialCanc_Click" Visible="False"></asp:button>
                                <asp:button id="btnTailQuote" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Tail Quote" style="margin-bottom: 4px;" onclick="btnTailQuote_Click"></asp:button>
                                <asp:button id="btnRegistry" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Registry" style="margin-bottom: 4px;" onclick="btnRegistry_Click"></asp:button>
                                <asp:button id="btnPrintCertificate" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Print Certificate" style="margin-bottom: 4px;" onclick="btnPrintCertificate_Click"></asp:button>
                                <asp:button id="btnPolicyCert" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Policy Cert." style="margin-bottom: 4px;" onclick="btnPolicyCert_Click" Visible="False"></asp:button>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                                    <div id="effect" class="col-md-4 ui-widget-header ui-corner-all f-center" aling="right" style="background:BB1509;width: 375px; height:250px; display:none">
                                        <div class="col-md-4">
                                            <asp:Label ID="Label49" runat="server" class="fs-14 fw-bold" Text="Select Rate"></asp:Label>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <asp:Label ID="Label13" runat="server" class="fs-lbl-s" Text="Specialty:"></asp:Label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:DropDownList ID="ddlRate" runat="server" class="form-select fs-txt-s" TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="ddlRate_SelectedIndexChanged">
                                                </asp:DropDownList>
                                                <asp:DropDownList ID="ddlRateExcess" runat="server" class="form-select fs-txt-s" TabIndex="1" Visible="False" AutoPostBack="True" OnSelectedIndexChanged="ddlRate_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <asp:Label ID="Label14" runat="server" class="fs-lbl-s" Text="Iso Code:"></asp:Label>
                                        <asp:TextBox ID="txtIsoCode" runat="server" class="form-control fs-txt-s" TabIndex="8"></asp:TextBox>

                                        <asp:Label ID="Label47" runat="server" Text="Class:"></asp:Label>
                                        <asp:TextBox ID="txtClass" runat="server" class="form-control fs-txt-s" TabIndex="8"></asp:TextBox>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <asp:Label ID="Label15" runat="server" class="fs-lbl-s" Text="Rate 1"></asp:Label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txtRate1" runat="server" class="form-control fs-txt-s" TabIndex="8"></asp:TextBox>

                                            </div>
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txtRate2" runat="server" class="form-control fs-txt-s" TabIndex="8"></asp:TextBox>

                                            </div>
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txtRate3" runat="server" class="form-control fs-txt-s" TabIndex="8"></asp:TextBox>

                                            </div>
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txtRate4" runat="server" class="form-control fs-txt-s" TabIndex="8"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <maskedinput:maskedtextbox id="txtHomePhone" CSSCLASS="form-control fs-txt-s telefoneFormat" RUNAT="server" MAXLENGTH="20" MASK="(999) 999-9999" ISDATE="False"></maskedinput:maskedtextbox>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <maskedinput:maskedtextbox id="txtWorkPhone" CSSCLASS="form-control fs-txt-s telefoneFormat" RUNAT="server" MAXLENGTH="20" MASK="(999) 999-9999" ISDATE="False"></maskedinput:maskedtextbox>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <maskedinput:maskedtextbox id="TxtCellular" CSSCLASS="form-control fs-txt-s telefoneFormat" RUNAT="server" MAXLENGTH="20" MASK="(999) 999-9999" ISDATE="False"></maskedinput:maskedtextbox>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <asp:TextBox ID="TxtRetroactiveDate" runat="server" Columns="30" onclick="ShowDateTimePicker2();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <asp:TextBox ID="txtEffDt" runat="server" Columns="30" IsDate="True" onclick="ShowDateTimePicker();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <asp:textbox id="txtExpDt" runat="server" Columns="30" IsDate="True" onclick="ShowDateTimePicker4();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:textbox>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <asp:textbox id="txtEntryDate" CSSCLASS="form-control fs-txt-s fechaFormat" runat="server" IsDate="True" Columns="30" onclick="ShowDateTimePickerEntryDate();"></asp:textbox>
                                                    </div>
                                                </div>
                                                <%--                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <asp:button id="btnChargeCalc" tabIndex="68" runat="server" BorderWidth="0px" BorderColor="#BB1509" BackColor="#BB1509" Text="Calculate" onclick="CalculateCharge" Visible="False" CssClass="btn-bg-theme2 btn-h-30 btn-r-4"></asp:button>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="mb-3 row">
                                                    <asp:Label ID="lblGapDate2" CSSCLASS="col-md-3 col-form-labe fs-lbl-s label-vertical-align" runat="server" EnableViewState="False">Num. of Employees:</asp:Label>
                                                    <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <asp:TextBox ID="txtGapBegDate" runat="server" Columns="30" onclick="ShowDateTimePicker6();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                                    </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <asp:TextBox ID="txtGapEndDate" runat="server" Columns="30" onclick="ShowDateTimePicker7();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <asp:TextBox ID="txtGapBegDate2" runat="server" Columns="30" onclick="ShowDateTimePicker8();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                                    </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <asp:TextBox ID="txtGapEndDate2" runat="server" Columns="30" onclick="ShowDateTimePicker9();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <asp:TextBox ID="txtGapBegDate3" runat="server" Columns="30" onclick="ShowDateTimePicker10();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                                    </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <asp:TextBox ID="txtGapEndDate3" runat="server" Columns="30" onclick="ShowDateTimePicker11();" CSSCLASS="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-12" style="height:29.2px;">
                                                                <%--<div class="input-group mb-3 input-append date datepicker-p1" data-date-format="mm-dd-yyyy">--%>
                                                                    <div>
                                                                        <asp:TextBox id="txtPriPolEffecDate1" Height="29.2px" Font-Size="8pt" Font-Names="Tahoma" RUNAT="server" ISDATE="True" CssClass="form-control fechaFormat" onclick="ShowDateTimePicker3();"></asp:TextBox>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <asp:DataGrid ID="DG_AdditialCoverages" runat="server" AlternatingItemStyle-BackColor="#BB1509" AlternatingItemStyle-CssClass="HeadForm3" AutoGenerateColumns="False" BackColor="White" BorderColor="#D6E3EA" CellPadding="0" HeaderStyle-BackColor="#5C8BAE"
                                                    HeaderStyle-ForeColor="White" HeaderStyle- HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="HeadForm3" ItemStyle-HorizontalAlign="center" OnItemCommand="dtEndorsement_ItemCommand" PageSize="8" TabIndex="9"
                                                    Width="403px" Visible="false" onitemcreated="DG_AdditialCoverages_ItemCreated">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <asp:TextBox ID="txtEndoEffDate" runat="server" CSSCLASS="form-control fs-txt-s fechaFormat" onclick="ShowDateTimePicker5();"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <asp:TextBox ID="txtRetroEffDate" runat="server" CSSCLASS="form-control fs-txt-s fechaFormat" onclick="ShowDateTimePickerEndoRetroDate();"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <asp:DataGrid ID="DtSearchPayments" runat="server" AllowPaging="True" AlternatingItemStyle-BackColor="#BB1509" AlternatingItemStyle-CssClass="HeadForm3" AutoGenerateColumns="False" BackColor="White" BorderColor="#D6E3EA" CellPadding="0" HeaderStyle-BackColor="#5C8BAE"
                                                            HeaderStyle- HeaderStyle-HorizontalAlign="Center" Height="193px" ItemStyle-CssClass="HeadForm3" ItemStyle-HorizontalAlign="center" OnItemCommand="DtSearchPayments_ItemCommand1" PageSize="8" TabIndex="9"
                                                            onitemcreated="DtSearchPayments_ItemCreated" Width="90%" HeaderStyle-ForeColor="White">
                                                            <FooterStyle BackColor="Navy" ForeColor="#003399" />
                                                            <EditItemStyle BackColor="White" HorizontalAlign="Center" />
                                                            <SelectedItemStyle BackColor="White" HorizontalAlign="Center" />
                                                            <PagerStyle BackColor="White" CssClass="Numbers" ForeColor="Blue" HorizontalAlign="Left" Mode="NumericPages" PageButtonCount="20" />
