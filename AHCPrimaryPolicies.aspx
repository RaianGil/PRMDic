                    ...
                    <div class="container-xl p-18 mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox ID="TxtRetroactiveDate" runat="server" Columns="30" class="form-control fs-txt-s fechaFormat"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtEffDt" runat="server" class="form-control fs-txt-s fechaFormat" Columns="30" IsDate="True"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <asp:textbox id="txtExpDt" runat="server" class="form-control fs-txt-s fechaFormat" Columns="30" IsDate="True" onclick="ShowDateTimePicker4();"></asp:textbox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <asp:textbox id="txtEntryDate" tabIndex="47" runat="server" class="form-control fs-txt-s fechaFormat" IsDate="True" Columns="30"></asp:textbox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-8">
                                        <maskedinput:maskedtextbox id="txtHomePhone" runat="server" class="form-control fs-txt-s telefoneFormat" MAXLENGTH="20" MASK="(999) 999-9999" ISDATE="False"></maskedinput:maskedtextbox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <maskedinput:maskedtextbox id="txtWorkPhone" runat="server" class="form-control fs-txt-s telefoneFormat" MAXLENGTH="20" MASK="(999) 999-9999" ISDATE="False"></maskedinput:maskedtextbox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <maskedinput:maskedtextbox id="TxtCellular" runat="server" class="form-control fs-txt-s telefoneFormat" MAXLENGTH="20" MASK="(999) 999-9999" ISDATE="False"></maskedinput:maskedtextbox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-8">
                                        <maskedinput:maskedtextbox id="TxtCancAmount" runat="server" cssclass="form-control fs-txt-s" MAXLENGTH="14" IsCurrency="False" MASK="CCCCCCCCCC" ISDATE="False" Enabled="False"></maskedinput:maskedtextbox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <maskedinput:maskedtextbox id="TxtTotalPremium" runat="server" cssclass="form-control fs-txt-s" MAXLENGTH="14" IsCurrency="False" MASK="CCCCCCCCCC" ISDATE="False" Enabled="False"></maskedinput:maskedtextbox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <MaskedInput:MaskedTextBox ID="txtInvoiceNumber" runat="server" cssclass="form-control fs-txt-s" IsCurrency="False" IsDate="False" Mask="CCCCCCCCCC" MaxLength="14"></MaskedInput:MaskedTextBox>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <MaskedInput:MaskedTextBox ID="TxtProspectNo" cssclass="form-control fs-txt-s" runat="server" Enabled="False" IsCurrency="False" ISDATE="False" MASK="CCCCCCCCCC" MAXLENGTH="14"></MaskedInput:MaskedTextBox>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    <asp:TextBox ID="txtGapBegDate" runat="server" class="form-control fs-txt-s fechaFormat" Columns="30" onclick="ShowDateTimePicker6();"></asp:TextBox>
                                                </div>
                                                <div class="col-md-12">
                                                    <asp:TextBox ID="txtGapBegDate2" runat="server" class="form-control fs-txt-s fechaFormat" Columns="30" onclick="ShowDateTimePicker8();"></asp:TextBox>
                                                </div>
                                                <div class="col-md-12">
                                                    <asp:TextBox ID="txtGapBegDate3" runat="server" class="form-control fs-txt-s fechaFormat" Columns="30" onclick="ShowDateTimePicker10();"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <asp:TextBox ID="txtGapEndDate" runat="server" class="form-control fs-txt-s fechaFormat" Columns="30" onclick="ShowDateTimePicker7();"></asp:TextBox>
                                                </div>
                                                <div class="col-md-12">
                                                    <asp:TextBox ID="txtGapEndDate2" runat="server" class="form-control fs-txt-s fechaFormat" Columns="30" onclick="ShowDateTimePicker9();"></asp:TextBox>
                                                </div>
                                                <div class="col-md-12">
                                                    <asp:TextBox ID="txtGapEndDate3" runat="server" class="form-control fs-txt-s fechaFormat" Columns="30" onclick="ShowDateTimePicker11();"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 f-right">
                                ...
                                <maskedinput:maskedtextbox id="txtPriPolEffecDate1" runat="server" class="form-control fs-txt-s mb-1 fechaFormat" ISDATE="True"></maskedinput:maskedtextbox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                ...
                                <asp:TextBox ID="txtEndoEffDate" runat="server" class="form-control fs-txt-s fechaFormat" onclick="ShowDateTimePicker5();"></asp:TextBox>
                            </div>
                            <div class="col-md-auto">
                                <asp:Label ID="lblEndoRetroDate" runat="server" class="fs-lbl-s" EnableViewState="False">Endo. Retro. Date:</asp:Label>
                                <asp:TextBox ID="txtRetroEffDate" runat="server" class="form-control fs-txt-s fechaFormat"></asp:TextBox>
