<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuoteAspen.aspx.cs" Inherits="QuoteAspen" %>
...
<head>
    ...
    <style type="text/css">
        .toggler { width: 276px; height: 2px; }
...
<script type="text/javascript">
    ...
    {
        $('#<%= txtExcessRetroDate.ClientID %>').datepicker('show');
    }     
...
<body onload ="pageLoad()"  background="Images2/SQUARE.GIF" bottommargin="0" leftmargin="0" rightmargin="0" topmargin="19">
    <form id="form1" runat="server">
    <div>
        <table id="Table8" align="center" bgcolor="white" border="0" cellpadding="0" cellspacing="0"
            datapagesize="25" style="z-index: 139; left: 4px; width: 657px; position: static;
            top: 4px; height: 1px">
            <tr>
            ...
            <tr>
                ...
                <td align="center" style="font-size: 0pt; width: 86px; height: 396px">
                    <p align="center">
                        <table id="Table9" bgcolor="white" border="0" cellpadding="0" cellspacing="0" style="width: 785px;
                            height: 64px">
                            <tr>
                                <td style="font-size: 0pt; " valign="top" class="style4">
                                    <table id="Table11" border="0" bordercolor="#4b0082" bordercolordark="#4b0082"
                                        bordercolorlight="#4b0082" cellpadding="0" cellspacing="0" 
                                        style="width: 814px; height: 77px;">
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="text-align: right" bgcolor="#A00000" >
                                                <asp:Button ID="btnConvertPrimary" runat="server" BackColor="#A00000" BorderColor="White"
                                                    BorderWidth="1px" Font-Names="Tahoma" ForeColor="White" Height="23px"
                                                    Text="Convert Primary" Width="130px" OnClick="btnConvertPrimary_Click" 
                                                    TabIndex="1" style="margin-right: 1px; margin-bottom: 1px;" 
                                                    BorderStyle="Solid" />
                                                <asp:Button ID="btnConvert" runat="server" BackColor="#A00000" BorderColor="White"
                                                    BorderWidth="1px" Font-Names="Tahoma" ForeColor="White" Height="23px"
                                                    Text="Convert Excess" Width="130px" OnClick="btnConvert_Click" 
                                                    TabIndex="1" style="margin-right: 1px;  margin-bottom: 1px;" 
                                                    BorderStyle="Solid" />
                                                <asp:Button ID="btnPrint" runat="server" BackColor="#A00000" BorderColor="White"
                                                    BorderWidth="1px" Font-Names="Tahoma" ForeColor="White" Height="23px"
                                                    Text="Print Quote" Width="80px" OnClick="btnPrint_Click" TabIndex="2" 
                                                    style="margin-right: 1px; margin-bottom: 1px;" BorderStyle="Solid" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right" bgcolor="#8A0E0C" >
                                                <asp:Button ID="btnRate" runat="server" Text="Rate" BackColor="#8A0E0C" 
                                                    BorderColor="White" BorderWidth="1px" Font-Names="Tahoma" Font-Size="9pt" 
                                                    ForeColor="White" Height="23px" Width="52px" 
                                                    style="margin-right: 7px; margin-bottom: 0px;" BorderStyle="Solid" />
                                                <asp:Button ID="BtnSave" runat="server" BackColor="#8A0E0C" BorderColor="White"
                                                    BorderWidth="1px" Font-Names="Tahoma" ForeColor="White" Height="23px" OnClick="BtnSave_Click"
                                                    TabIndex="70" Text="Save" Width="65px" style="margin-right: 1px" 
                                                    BorderStyle="Solid" />
                                                <asp:Button ID="btnEdit" runat="server" BackColor="#8A0E0C" BorderColor="White"
                                                    BorderWidth="1px" Font-Names="Tahoma" ForeColor="White" Height="23px"
                                                    Text="Modify" Width="65px" OnClick="btnEdit_Click" TabIndex="4" 
                                                    style="margin-right: 1px" BorderStyle="Solid" />
                                                <asp:Button ID="btnDelete" runat="server" BackColor="#8A0E0C" BorderColor="White"
                                                    BorderWidth="1px" Font-Names="Tahoma" ForeColor="White" Height="23px"
                                                    Text="Delete" Width="65px" OnClick="btnDelete_Click" TabIndex="1" 
                                                    style="margin-right: 1px" BorderStyle="Solid" />
                                                <asp:Button ID="btnCancel" runat="server" BackColor="#8A0E0C" BorderColor="White"
                                                    BorderWidth="1px" Font-Names="Tahoma" ForeColor="White" Height="23px"
                                                    Text="Cancel" Width="65px" OnClick="btnCancel_Click" TabIndex="3" 
                                                    style="margin-right: 1px" BorderStyle="Solid" />
                                                <asp:Button ID="BtnExit" runat="server" BackColor="#8A0E0C" BorderColor="White"
                                                    BorderWidth="1px" Font-Names="Tahoma" ForeColor="White" Height="23px"
                                                    Text="Exit" Width="80px" OnClick="BtnExit_Click" TabIndex="5" 
                                                    BorderStyle="Solid" />
                                            </td>
                                        </tr>
                                        <tr>
                                                                ...
                                                                <!--h3 class="" style="font-size: 14pt; font-family: Tahoma; text-decoration: underline">
                                                                  ...
                                                                  <p>                                                              
                                                                    <span style="font-size: 9pt"> 
                                                                        ...
                                                                        <table style="width: 244px; font-size: 9pt;" border="1" bordercolor="#330000" bordercolordark="#000000" bordercolorlight="#990000">
                                                                            <tr>
                                                                    ...
                                                                    <asp:Label ID="Label49" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="14pt"
                                                                        Font-Underline="True" Text="Select Rate" Width="116px"></asp:Label></td>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" colspan="5" height="16">
                                                                                    <asp:RadioButton ID="RadioButton1" runat="server" Text="Primary" AutoPostBack="True" OnCheckedChanged="RadioButton1_CheckedChanged" />
                                                                                        <asp:RadioButton ID="RadioButton2" runat="server" Text="Excess" AutoPostBack="True" OnCheckedChanged="RadioButton2_CheckedChanged" /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td height="14" align="right">
                                                                                    <asp:Label ID="Label51" runat="server" Font-Names="Tahoma" Font-Size="9pt" Text="Primary Retro Date:"
                                                                                        Width="129px"></asp:Label></td>
                                                                                <td height="14" style="width: 155px">
                                                                                    <MaskedInput:MaskedTextBox ID="txtPrimaryRetroDate" runat="server" CssClass="headfield1"
                                                                                ...
                                                                                <td height="14" style="width: 83px">
                                                                                    <MaskedInput:MaskedTextBox ID="txtExcessRetroDate" runat="server" CssClass="headfield1"
                                                                            ...
                                                                            <tr>
                                                                                <td height="14">
                                                                                    <asp:Label ID="Label63" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="10pt"
                                                                                        Text="Primary  Rate" Width="120px"></asp:Label></td>
                                                                                <td height="14" style="width: 155px">
                                                                            ...
                                                                            <tr>
                                                                                <td height="14">
                                                                                    <asp:DropDownList ID="ddlPrimaryLimits1" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                            ...
                                                                            <tr>
                                                                                <td height="14">
                                                                                    <asp:DropDownList ID="ddlLimits" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                                        Font-Size="8.5pt" Height="20px"
                                                                            ...
                                                                            <tr>
                                                                                <td height="14">
                                                                                    <asp:DropDownList ID="ddlLimits2" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                                        Font-Size="8.5pt" Height="20px"
                                                                            ...
                                                                            <tr>
                                                                                <td height="14">
                                                                                    <asp:DropDownList ID="ddlLimits3" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                                        Font-Size="8.5pt" Height="20px"
                                                                            ...
                                                                            <tr>
                                                                                <td height="14">
                                                                                    <asp:DropDownList ID="ddlLimits4" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                                        Font-Size="8.5pt" Height="20px"
                                                                            ...
                                                                            <tr>
                                                                                <td height="14">
                                                                                    <asp:DropDownList ID="ddlLimits5" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                                        Font-Size="8.5pt" Height="20px"
                                                                                        TabIndex="1" Width="136px" AutoPostBack="True" ForeColor="Black">
                                                                                    </asp:DropDownList></td>
                                                                                <td height="14" style="width: 155px">
                                                                            ...
                                                                            <tr>
                                                                                <td height="14">
                                                                                    <asp:DropDownList ID="ddlLimits6" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                                        Font-Size="8.5pt" Height="20px"
                                                                                        TabIndex="1" Width="136px" AutoPostBack="True" ForeColor="Black">
                                                                                    </asp:DropDownList></td>
                                                                                <td height="14" style="width: 155px">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left" height="14" style="width: 83px" colspan="4"><asp:DropDownList ID="ddlPolicyClass" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                                        Font-Size="9pt" Height="20px"
                                                                                        TabIndex="1" Width="228px" OnSelectedIndexChanged="ddlPolicyClass_SelectedIndexChanged1" AutoPostBack="True">
                                                                                </asp:DropDownList></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td height="14" colspan="5"><asp:DropDownList ID="ddPrimarylPolicyClass" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                                                        Font-Size="9pt" Height="20px"
                                                                                        TabIndex="1" Width="228px" AutoPostBack="True" OnSelectedIndexChanged="ddPrimarylPolicyClass_SelectedIndexChanged" Visible="False">
                                                                                </asp:DropDownList></td>
                                                                            </tr>
                                                                            <tr>
                            ...
                            <tr>
                                <td align="center" style="font-size: 2pt; " valign="middle">
                                    <table id="Table6" border="0" cellpadding="0" cellspacing="0" style="width: 808px;
                                        height: 112px">
                                        <tr>
                                            <td align="center" style="font-size: 1pt; height: 169px;" bordercolor="silver" valign="top">
                                                <table id="Table1" border="1" cellpadding="0" cellspacing="0" style="width: 100%;
                                                    height: 1px" width="806" bordercolor="silver">
                                                    <tr>
                                                        <td style="width: 200px; height: 11px" align="left" colspan="2">
                                                            <asp:Label ID="Label2" runat="server" CssClass="headfield1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 330px; height: 11px">
                                                            <asp:DropDownList ID="ddlAgency" runat="server" CssClass="headfield1" Font-Names="Tahoma"
                                                    ...
                                                    <tr>
                                                        <td style="width: 19%; height: 10px" align="left">
                                                             <asp:Label ID="Label54" runat="server" CssClass="headfield1" EnableViewState="False"
                                                                ...
                                                                Font-Names="Tahoma" Font-Size="9pt" Height="2px">Name:  Dr (a).</asp:Label></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 15%; height: 11px">
                                                            <asp:Label ID="Label59" runat="server" CssClass="headfield1" EnableViewState="False"
                                                                Font-Names="Tahoma" Font-Size="10pt" ForeColor="Red" Height="2px" Width="1px">*</asp:Label>
                                                            <asp:Label ID="Label3" runat="server" CssClass="headfield1" EnableViewState="False"
                                                        ...
                                                        <td align="left" style="width: 331px; height: 11px">
                                                            <MaskedInput:MaskedTextBox ID="txtWorkPhone" runat="server" CssClass="headfield1"
                                                    ...
                                                    <tr>
                                                        <td style="width: 19%; height: 11px" align="left">
                                                            <asp:Label ID="lblComments" runat="server" CssClass="headfield1" EnableViewState="False"
                                                        ...
                                                        <td style="width: 15%; height: 11px" align="left">
                                                            <asp:Label ID="lblLastName1" runat="server" CssClass="headfield1" EnableViewState="False"
                                                                Font-Names="Tahoma" Font-Size="9pt" Height="2px" Width="60px">Office Fax:</asp:Label></td>
                                                        <td style="width: 331px; height: 10px" align="left">
                                                            <MaskedInput:MaskedTextBox ID="TxtCellular" runat="server" CssClass="headfield1"
                                                                Font-Names="Tahoma" Font-Size="9pt" Height="12px" IsCurrency="False" IsDate="False"
                                                    ...
                                                    <tr>
                                                        <td align="center" style="width: 211px" colspan="" bordercolor="silver">
                                                            <asp:Label ID="Label18" runat="server" CssClass="headfield1" EnableViewState="False"
                                                                Font-Names="Tahoma" Font-Size="9pt" Height="18px" Width="144px">Primary Carrier Name</asp:Label></td>
