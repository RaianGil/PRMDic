<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of Application1.aspx.cs" Inherits="Application1" %>
                            ...
                            <tr>
                                <td style="font-size: 0pt; " valign="top" class="style4">
                                    <table id="Table11" border="0" bordercolor="#4b0082" bordercolordark="#4b0082"
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <asp:Button ID="btnConvertPrimary" runat="server" BackColor="#400000" BorderColor="#400000"
                                                    ...
                                                    Text="Convert Primary" Width="125px" OnClick="btnConvertPrimary_Click" 
                                        ...
                                        <tr>
                                            <td >
                                                <asp:Button ID="btnConvert" runat="server" BackColor="#400000" BorderColor="#400000"
                                                    ...
                                                    TabIndex="1" style="margin-right: 1px" />
                                            </td>
                                            <td align="right" >
                                                <asp:Button ID="btnRate" runat="server" Text="Rate" BackColor="#400000" 
                                                    BorderColor="#400000" BorderWidth="0px" Font-Names="Tahoma" Font-Size="9pt" 
                                                    ForeColor="White" Height="23px" Width="52px" 
                                                    style="margin-right: 7px; margin-bottom: 0px;" />
                                        ...
                                        <tr>
                                            <td background="Images2/Barra3.jpg" colspan="3" align="center">
