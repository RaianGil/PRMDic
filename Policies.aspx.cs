...
namespace EPolicy
{
    ...
    {
        private System.Data.DataTable DtTaskPolicy;
        private System.Data.DataTable DtEndorsement;
        private int userID;
                            ...
                            switch (taskControl.Mode)
                            {
                                ...
                                case 2: //UPDATE
                                    ...
                                    if (taskControl.isEndorsement)
                                    {
                                        ...
                                        CHKCyberEndorsment.Enabled = false;
                                    }
                                    else
                                        EndorsementControl(false);
        ...
        override protected void OnInit(EventArgs e)
        {
            try
            {
                ...
                if (Session["LookUpTables"] == null)
                {
                    ...
                    System.Data.DataTable dtLocation = LookupTables.LookupTables.GetTable("Location");
                    //DataTable dtBank = LookupTables.LookupTables.GetTable("Bank");
                    System.Data.DataTable dtAgency = LookupTables.LookupTables.GetTable("Agency");
                    System.Data.DataTable dtCity = LookupTables.LookupTables.GetTable("Sucursal");
                    System.Data.DataTable dtAgent = LookupTables.LookupTables.GetTable("Agent");
                    System.Data.DataTable dtAgent2 = LookupTables.LookupTables.GetTable("PrimaryAgentWithSecondaryCommissions");
                    System.Data.DataTable dtInsuranceCompany = LookupTables.LookupTables.GetTable("InsuranceCompany");
                    System.Data.DataTable dtInsuranceCompany2 = LookupTables.LookupTables.GetTable("InsuranceCompany2");
                    System.Data.DataTable dtPRMedicalLimit = LookupTables.LookupTables.GetTable("PRMedicalLimit");
                    System.Data.DataTable dtPRPrimaryLimit = LookupTables.LookupTables.GetTable("PRPrimaryLimit");

                    //DataTable dtPRMEDICRATE = LookupTables.LookupTables.GetTable("PRMEDICRATE");
                    System.Data.DataTable dtFinancial = LookupTables.LookupTables.GetTable("Financial");
                    System.Data.DataTable dtSpec = TaskControl.Policies.GetPRMEDICRATEPRIMARYNOAHC();
                    System.Data.DataTable dtEndorsementsType = LookupTables.LookupTables.GetTable("EndorsementsTypeWithCyber");


                    //DataTable dtPRMEDICRATE1 = EPolicy.LookupTables.LookupTables.GetTable("PRMEDICSpecialty");
                    //ddlRate.Items.Clear();
                    //ddlRate.DataSource = dtSpec;
                    ...
                    //ddlSpecialty.DataSource = dtSpec;
                    ...
                    System.Data.DataTable dtPRMEDICRATE2 = EPolicy.LookupTables.LookupTables.GetTable("PRMEDICSpecialty");
                    ...
                    //dtSpec.DefaultView.Sort = "IsoCode";
                    //dtSpec = dtSpec.DefaultView.ToTable();
                    //ddlIsoCode.DataSource = dtSpec;
                    ...
                    System.Data.DataTable dtPolicyClass = LookupTables.LookupTables.GetTable("PolicyClass");
                    ...
                    System.Data.DataTable dtCorporation = master.GetMasterPolicyByIsGroup(false);
                    System.Data.DataTable dtGroup = master.GetMasterPolicyByIsGroup(true);
        ...
        private void FillGrid()
        {
            try
            {
                ...
                if (taskControl.PolicyType.ToString().Trim().Length >= 3 &&
                    (taskControl.PolicyType.ToString().Trim() != "AAP" && taskControl.PolicyType.ToString().Trim() != "AAE"))
                ...
                //{
                //    double TotalPremium=0.00,Charge=0.00,CyberEndorsement=0.00;

                //    if (DtTaskPolicy.Rows[i]["TotalPremium"] != null && DtTaskPolicy.Rows[i]["TotalPremium"].ToString() != "")
                //    {
                //        TotalPremium = double.Parse(DtTaskPolicy.Rows[i]["TotalPremium"].ToString());
                //    }
                //    if (DtTaskPolicy.Rows[i]["Charge"] != null && DtTaskPolicy.Rows[i]["Charge"].ToString() != "")
                //    {
                //        Charge = double.Parse(DtTaskPolicy.Rows[i]["Charge"].ToString());
                //    }
                //    if (DtTaskPolicy.Rows[i]["CyberEndorsementPremium"] != null && DtTaskPolicy.Rows[i]["CyberEndorsementPremium"].ToString() != "")
                //    {
                //        CyberEndorsement = double.Parse(DtTaskPolicy.Rows[i]["CyberEndorsementPremium"].ToString());
                //    }

                //    DtTaskPolicy.Rows[i]["TotalPremium"] = TotalPremium + Charge + CyberEndorsement;
                //}
        ...
        private void FillTextControl()
        {
            try
            {
                ...
                {
                    CHKCyberEndorsment.Visible = false;
                }
                ...
                if (taskControl.PRMedicalLimit != 0)
                {
                    SetDDLLimit(taskControl.PRMedicalLimit, taskControl.PRMedicalLimit);
                }
                ...
                if (taskControl.PRMedicRATEID != 0)
                {
                    for (int i = 0; i < ddlRate.Items.Count; i++)
                    {
                        if (ddlRate.Items[i].Value.Trim() != "")
                        {
                            ...
                            if (taskControl.PRMedicRATEID == int.Parse(array[0].ToString().Trim()))
                            {
                                ddlRate.SelectedIndex = ddlRate.Items.IndexOf(
                ...
                //if (taskControl.PRMedicRATEID != 0)
                //{
                //    for (int i = 0; i < ddlRateExcess.Items.Count; i++)
                //    {
                //        if (ddlRateExcess.Items[i].Value.Trim() != "")
                //        {
                //            string[] array = ddlRateExcess.Items[i].Value.Split('|');
                //            if (taskControl.PRMedicRATEID == int.Parse(array[0]))
                //            {
                //                ddlRateExcess.SelectedIndex = ddlRateExcess.Items.IndexOf(
                //                ddlRateExcess.Items.FindByValue(ddlRateExcess.Items[i].Value));
                //            }
                //        }
                //    }
                //}
                ...
                {
                    TxtCancAmount.Text = taskControl.CancellationAmount.ToString("-###,##0.00");
                }
                else
                {
                    TxtCancAmount.Text = "0.00";
                }
                TxtTotalPremium.Text = ((taskControl.Charge + taskControl.TotalPremium) - taskControl.CancellationAmount).ToString("###,##0.00");

                //Antes No habia Derrama, ahora si 1/24/2019
                //TxtPremium.Text = ((taskControl.Charge + taskControl.TotalPremium) - taskControl.CancellationAmount).ToString("###,##0.00");
                TxtPremium.Text = ((taskControl.TotalPremium) - taskControl.CancellationAmount).ToString("###,##0.00");
                if (taskControl.CancellationAmount > 0)
                {
                ...
                {
                    CHKCyberEndorsment.Checked = true;
                    FillDG_AdditialCoverages(taskControl.CyberEndorsementPremium.ToString());
                    AddCyberEndorsment();
                }
                ...
                if (taskControl.CyberEndorsementPremium != 0.00)
                {
                    btnPrintCyberEndorsement.Visible = true;
                }
                else
                {
                    btnPrintCyberEndorsement.Visible = false;
                }

                txtAddCyberEndorsmentPremium.Visible = false;
                lblAddCyberEndorsmentPremium.Visible = false;

                lblCyberRetroDate.Visible = false;
                txtCyberRetroDate.Visible = false;

                if (Session["IsRenewal"] != null && Session["IsRenewal"].ToString() == "Yes")
                {
                    if (taskControl.CyberEndorsementPremium != 0.00)
                    {
                        lblAddCyberEndorsmentPremium.Visible = true;
                        txtAddCyberEndorsmentPremium.Visible = true;

                        lblCyberRetroDate.Visible = true;
                        txtCyberRetroDate.Visible = true; 
                    }


                    txtAddCyberEndorsmentPremium.Text = taskControl.CyberEndorsementPremium.ToString();
                    System.Data.DataTable dtcyber = GetLastPolicyCyberEndorsementByTaskcontrolID(taskControl.PolicyNo, taskControl.PolicyType);


                    if (dtcyber.Rows.Count > 0)
                    {
                        int LatesttaskcontrolID = 0;
                        string RetroActiveDate = "";
                        for (int i = 0; i < dtcyber.Rows.Count; i++)
                        {
                            if (int.Parse(dtcyber.Rows[i]["TaskcontrolID"].ToString()) > LatesttaskcontrolID && dtcyber.Rows[i]["EndorsementTypeID"].ToString() == "5")
                            {
                                LatesttaskcontrolID = int.Parse(dtcyber.Rows[i]["TaskcontrolID"].ToString());
                                RetroActiveDate = dtcyber.Rows[i]["RetroactiveDate"].ToString();
                            }
                        }
                        if (LatesttaskcontrolID > 0)
                        {
                            txtCyberRetroDate.Text = DateTime.Parse(RetroActiveDate).ToShortDateString(); 
                        }
                    }
                }
        ...
        private void EnableControls()
        {
            ...
            CHKCyberEndorsment.Enabled = true;
            ...
            else
            {
                ...
                Button3.Visible = true;
                if (cp.IsInRole("PRINTEXCESSCERTIFICATE"))
                    btnPrintCertificate.Visible = true;
                else
                    btnPrintCertificate.Visible = false;
            }
            ...
            if (taskControl.CyberEndorsementPremium !=0.00)
            {
                txtCyberPremium.Visible = true;
                lblCyberPremium.Visible = true;
            }
            ...
            try
            {
                ...
                if (!taskControl.isEndorsement)
                {
                    ...
                    if (taskControl.CyberEndorsementPremium != 0.00)
                    {
                        EPolicy.TaskControl.PaymentPolicy payments2 = new EPolicy.TaskControl.PaymentPolicy();
                        payments2 = PaymentPolicy.GetPaymentsByTaskControlID(taskControl);
                        System.Data.DataTable dtend = GetLastPolicyCyberEndorsementByTaskcontrolID(taskControl.PolicyNo, taskControl.PolicyType);
                        ...
                        for (int i = 0; i < payments2.PaymentsCollection.Rows.Count; i++)
                        {
                            if (payments2.PaymentsCollection.Rows[i]["CheckNumber"].ToString().Contains("Inception Cyber End."))
                            {
                        ...
                        {
                            if (dtend.Rows[i]["taskcontrolid"].ToString().Trim() == taskControl.TaskControlID.ToString().Trim() && dtend.Rows[i]["EndorsementTypeID"].ToString().Trim() == "5")
                            {
                        ...
                        if (!HasCyberPayment)
                        {
                            AddCyberEndorsmentPartialPayments(taskControl);
                        }
                        ...
                        if (!HasCyberEndorsement)
                        {
                            ...
                            AddEndorsementCyber(taskControl.TaskControlID);
                        }
                    }
        ...
        private void FillProperties()
        {
            try
            {
                ...
                taskControl.LbxAgentSelected = listtest;
                //ddlSelectedAgent = null;
                ...
                if (ddlSupplier.SelectedIndex > 0 && ddlSupplier.SelectedItem != null)
                {
                    ...
                    System.Data.DataTable dt = LookupTables.Supplier.GetGroupSupplierBySupplierID(ddlSupplier.SelectedItem.Value.Trim());
                ...
                {
                    taskControl.PolicyDetailcs.PolicyDetailTableTemp = (System.Data.DataTable)Session["DtPolicyDetail"];
                }
                ...
                if (CHKCyberEndorsment.Checked)
                {
                    taskControl.CyberEndorsementPremium = double.Parse(txtCyberPremium.Text.Trim());
                }
                else
                {
                    taskControl.CyberEndorsementPremium = 0.00;
                }
        ...
        protected void btnCancel_Click(object sender, System.EventArgs e)
        {
            ...
            if (taskControl.isEndorsement)
            {
                ...
                DG_AdditialCoverages.DataSource = null;
                DG_AdditialCoverages.Visible = false;
                CHKCyberEndorsment.Checked = false;
        ...
        private List<string> PrintCyberEndorsment(int counter, List<string> mergePathsCertificate)
        {
            TaskControl.Policy taskControl = (TaskControl.Policy)Session["TaskControl"];
            List<string> mergePaths2 = new List<string>();
            ...
            try
            {
                    ...
                    string ReportPath = "";
                    ReportPath = "Reports/CyberEndorsement/eMedDefenseCyberEndorsement"+counter+".rdlc";
                    ...
                    ReportParameterInfoCollection paramCol = viewer.LocalReport.GetParameters();
                    ReportParameter rp1 = new ReportParameter(paramCol[0].Name, taskControl.PolicyNo);
                    ReportParameter rp2 = new ReportParameter(paramCol[1].Name, taskControl.EffectiveDate);
                    ReportParameter rp3 = new ReportParameter(paramCol[2].Name, taskControl.RetroactiveDate);
                    ...
                    string encoding = string.Empty;
                    string extension;
                    string fileName = VerifyFileName(taskControl.Customer.FirstName + taskControl.Customer.LastName1.ToString().Trim() + counter);
                    _FileName = VerifyFileName(taskControl.Customer.FirstName + taskControl.Customer.LastName1.ToString().Trim() + counter + ".pdf");
                    ...
                    string fullFilePath = currentApplicationPath + "Reports\\CyberEndorsement\\eMedDefenseCyberEndorsement.pdf";
                    string copyToPath = System.Configuration.ConfigurationManager.AppSettings["ExportsFilesPathName"] + "eMedDefenseCyberEndorsement.pdf";
                    File.Copy(fullFilePath , copyToPath,true);
                    mergePathsCertificate.Add(System.Configuration.ConfigurationManager.AppSettings["ExportsFilesPathName"] + "eMedDefenseCyberEndorsement.pdf");

                   // mergePathsCertificate.Add("Reports/CyberEndorsement/eMedDefenseCyberEndorsement.pdf");
        ...
        private string PrintRegister(string rdlcDocument)
        {
            ...
            try
            {
                ...
                viewer.LocalReport.DataSources.Clear();
                viewer.ProcessingMode = ProcessingMode.Local;
                viewer.LocalReport.ReportPath = Server.MapPath("Reports/" + rdlcDocument);//("Reports/Report2.rdlc");
                ...
                if (TxtPolicyType.Text.Trim() == "AAP")
                {
                    param[12] = new ReportParameter("EntryDt", "");
                }
                else
                {
                    param[12] = new ReportParameter("EntryDt", "X");
                }

                if (TxtPolicyType.Text.Trim() == "AAE" && taskControl.InsuranceCompany.ToString() == "000")
                {
                    param[12] = new ReportParameter("EntryDt", "");
                }
                ...
                System.Data.DataTable DtTask = TaskControl.TaskControl.GetTaskControlByCustomerNo(taskControl.Customer.CustomerNo);
        ...
        public static System.Data.DataTable GetAgencyDesc(string AgencyID)
        {
            System.Data.DataTable dt = new System.Data.DataTable();
        ...
        public static System.Data.DataTable GetAgentDesc(int AgentID)
        {
            System.Data.DataTable dt = new System.Data.DataTable(); 
        ...
        private string PrintInvoiceForm(string rdlcDocument)
        {
            try
            {
                ...
                param[14] = new ReportParameter("Agent", ddlAgent.SelectedItem.Text.ToString());
        ...
        protected void btnPrintPolicy_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                List<string> mergePaths2 = new List<string>();
                List<string> mergePaths3 = new List<string>();
                ...
                if (taskControl.CancellationDate != String.Empty)
                {
                    ...
                    {
                        if (taskControl.CancellationReason != 10)
                        {
                        ...
                        {
                            param[10] = new ReportParameter("MOC2", "");
                            param[11] = new ReportParameter("MOC5Exp", "");
                            param[12] = new ReportParameter("Finance", "X");
                        }
                    }
                    ...
                    {
                        if (taskControl.CancellationMethod == 2 && taskControl.CancellationReason == 10)
                        {
                            param[12] = new ReportParameter("Finance", "X");
                            param[13] = new ReportParameter("RSC4Date", "");
                        }
                    ...
                    else if (taskControl.CancellationReason == 8)
                    {
                        param[12] = new ReportParameter("RSC3", "X");
                        param[13] = new ReportParameter("RSC3Date", "");

                    }
                    else if (taskControl.CancellationReason == 37)
                    {
                        param[12] = new ReportParameter("Finance", "X");
                        param[13] = new ReportParameter("FinanceDate", DateTime.Parse(taskControl.CancellationReasonDesc).ToString("MMMM dd, yyyy"));
                    }
                ...
                else if (taskControl.PolicyType.Trim() == "PP")// || taskControl.PolicyType.Trim() == "PE")
                {
                    if (taskControl.Anniversary == "01")
                    {
                        ...
                        if (!taskControl.PrintPolicy && DateTime.Parse(taskControl.EffectiveDate.Trim()) < DateTime.Parse("08/01/2015"))//&& prmdicAdmin)
                        {
                            ...
                            rpt = new EPolicy2.Reports.PRMdic.Invoice((EPolicy.TaskControl.Policy)taskControl, false);//Ruben
                        ...
                        else if (!taskControl.PrintPolicy && DateTime.Parse(taskControl.EffectiveDate.Trim()) >= DateTime.Parse("08/01/2015"))
                        {
                            ...
                            if (taskControl.PolicyType.Trim() == "PP")
                            {
                                ...
                                if (taskControl.CyberEndorsementPremium != 0.00)
                                {
                                    mergePaths3 = PrintCyberEndorsment(1, mergePaths2);
                                    //for (int i = 2; i <= 4; i++)
                                    //{
                                    //    mergePaths3 = PrintCyberEndorsment(i, mergePaths3);
                                    //}
                            ...
                            else
                            {
                                if (taskControl.CyberEndorsementPremium != 0.00)
                                {
                                    mergePaths3 = PrintCyberEndorsment(1, mergePaths);
                                    //for (int i = 2; i <= 4; i++)
                                    //{
                                    //  mergePaths3 = PrintCyberEndorsment(i, mergePaths3);
                                    //}
                    ...
                    else //Renovacion.
                    {
                        ...
                        if (!taskControl.PrintPolicy) //Proof that the renovation was printed.
                        {
                            ...
                            mergePaths.Add(PrintRegister("Report2New.rdlc")); //old Report2.rdlc
                            ...
                            if (taskControl.PolicyType.ToString().Trim() == "PP")
                                mergePaths2 = PrintCertificateReports("295", 1, mergePaths);//Certificado Nuevo Pedidio por Estefania
                ...
                else if (taskControl.PolicyType.Trim() == "PE")//PE
                {
                    if (taskControl.Anniversary == "01")
                    {
                        ...
                        if (!taskControl.PrintPolicy && DateTime.Parse(taskControl.EffectiveDate.Trim()) < DateTime.Parse("08/01/2015"))//&& prmdicAdmin)
                        {
                            ...
                            DataDynamics.ActiveReports.ActiveReport3 rpt34 = null;


                            //mergePaths.Add(PrintInvoiceForm("Invoice.rdlc"));


                            rpt34 = new EPolicy2.Reports.PRMdic.Invoice(taskControl, false);//Ruben
                            rpt34.Document.Printer.PrinterName = "";
                            rpt34.Run(false);
                        ...
                        else if (!taskControl.PrintPolicy && DateTime.Parse(taskControl.EffectiveDate.Trim()) >= DateTime.Parse("08/01/2015"))
                        {
                            ...
                            rpt34 = new EPolicy2.Reports2.PRMdic.PolizaNew();
                            rpt34.Document.Printer.PrinterName = "";
                            rpt34.Run(false);
                            rpt.Document.Pages.InsertRange(rpt.Document.Pages.Count, rpt34.Document.Pages);
                ...
                else if (taskControl.PolicyType.Trim() == "AAP")
                {
                    ...
                    else //Renovacion.
                    {
                        ...
                        if (!taskControl.PrintPolicy) //Proof that the renovation was printed.
                        {
                            ...
                            mergePaths.Add(PrintRegister("Report2NewAspen.rdlc")); //old Report2.rdlc
                ...
                else if (taskControl.PolicyType.Trim() == "PP")// || taskControl.PolicyType.Trim() == "PE")
                {
                    ...
                    else //Renovacion.
                    {
                        ...
                        if (!taskControl.PrintPolicy) //Proof that the renovation was printed.
                        {
                            ...
                            //mergePaths.Add(PrintRegister("Report2New.rdlc")); //old Report2.rdlc
                            mergePaths.Add(PrintWordProcessedPath("PolicyType = '"+ taskControl.PolicyType +"' and FormName = 'CREDENCIALES RENOVACION'", false));
                ...
                else if (taskControl.PolicyType.Trim() == "AAP")
                {
                    ...
                    else //Renovacion.
                    {
                        ...
                        if (!taskControl.PrintPolicy) //Proof that the renovation was printed.
                        {
                            ...
                            //mergePaths.Add(PrintRegister("Report2NewAspen.rdlc")); //old Report2.rdlc
                            mergePaths.Add(PrintWordProcessedPath("PolicyType = '" + taskControl.PolicyType + "' and FormName = 'CREDENCIALES RENOVACION'", false));
                            mergePaths.Add(PrintWordProcessedPath("PolicyType = '" + taskControl.PolicyType.Trim() + "' and FormName = 'INSURANCE APPLICATION UPDATE'", false));
        ...
        protected void btnPrintPolicyWord_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (taskControl.PolicyType.Trim() == "APP" || taskControl.PolicyType.Trim() == "AEE" || taskControl.PolicyType.Trim() == "AAE" || taskControl.PolicyType.Trim() == "AAP" || taskControl.PolicyType.Trim() == "AAET" || taskControl.PolicyType.Trim() == "AAPT")
                    {
                        Print();
                    }
                    else
                    {
                        if (taskControl.Anniversary == "01")
                        {
                            PrintWord(ConstructWhereClauseForReport(), true);
                        }
                        else
                        {
                            if (DateTime.Parse(taskControl.EffectiveDate) >= DateTime.Parse("01/01/2021"))
                            {
                                PrintWord(ConstructWhereClauseForReport(), true);
                            }
                            else
                            {
                                Print();
                                //PrintWord(ConstructWhereClauseForReport(), true); //este debe ir comentado 
                            }
                        }
                    }
                }
            ...
            {
                LogError(ex);
                this.litPopUp.Text = Utilities.MakeLiteralPopUpString("Error Printing Policy");
                this.litPopUp.Visible = true;
            }
        }
        ...
        protected void btnPrintCyberEndorsement_Click(object sender, System.EventArgs e)
        {
            PrintWord("PolicyType = 'PP' and FormName = 'eMed Defense Cyber Endorsement'",false);
        }
        ...
        protected void btnDelete_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                note = "[DELETED POLICY]: " + "\r\n"
                        ...
                        + "POLICY NUM: "+ taskControl.PolicyType.Trim() + taskControl.PolicyNo.Trim() +"\r\n";

                History(i, userID, "DELETE", "POLICIES",note);
        ...
        protected void btnReinstatement_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (Session["DtPolicyDetail"] != null)
                {
                    policies.PolicyDetailcs.PolicyDetailTableTemp = (System.Data.DataTable)Session["DtPolicyDetail"];
                }
        ...
        protected void btnRenew_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                policies.CyberEndorsementPremium = taskControl.CyberEndorsementPremium;
                ...
                // Determina si es necesario Recalcular la prima cuando se grabe la renovación
        ...
        private void SetDDLLimit(int LimitID, int primaryLimit)
        {
            ...
            System.Data.DataTable dtPRMEDICRATE2 = null;
            //Primary
            if (taskControl.PolicyType.Trim() == "PE" || taskControl.PolicyType.Trim() == "AAE")
            {
                int id = 0;
                //if (ddlPriPolLimits1.SelectedValue == "")
                //    id = LimitID;
                //else
                //    id = int.Parse(ddlPriPolLimits1.SelectedValue);
                ...
                dtPRMEDICRATE2 = EPolicy.TaskControl.Application.GetPRMEDICRATE(id);
            }
            else 
            {
                dtPRMEDICRATE2 = EPolicy.TaskControl.Application.GetPRMEDICPrimaryRATE(primaryLimit);
            }
           ...
           // ddlRate.SelectedIndex = -1;
            ...
            System.Data.DataTable dtExcess = EPolicy.TaskControl.Application.GetPRMEDICRATEBYISOCODE(0, txtIsoCode.Text.Trim());
            System.Data.DataTable dtPRMEDICRATEPRIMARY = EPolicy.TaskControl.Application.GetPRMEDICRATEPRIMARYBYISOCODE(0, txtIsoCode.Text.Trim());

          if (taskControl.PolicyType.Trim() == "PE" || taskControl.PolicyType.Trim() == "AAE")
          {
              ddlRate.SelectedIndex = ddlRate.Items.IndexOf(
                                ddlRate.Items.FindByText(dtExcess.Rows[0]["PRMEDICRATEDesc"].ToString().Trim()));
          }
          else 
          {
              ddlRate.SelectedIndex = ddlRate.Items.IndexOf(
                                ddlRate.Items.FindByText(dtPRMEDICRATEPRIMARY.Rows[0]["PRMEDICRATEDesc"].ToString().Trim()));
          }
        ...
        protected void DtSearchPayments_ItemCommand1(object source, DataGridCommandEventArgs e)
        {
            ...
            else  // Pager
            {
                ...
                DtSearchPayments.DataSource = (System.Data.DataTable)Session["DtTaskPolicy"];
                DtSearchPayments.DataBind();
            }
        }
        ...
        private void Recalculate()
        {
            try
            {
                ...
                System.Data.DataTable dtPRMEDICRATE2 = null;
                System.Data.DataTable dtPRMEDICRATEPRIMARY2 = null;
                ...
                //SetDDLLimit(int.Parse(ddlPrMedicalLimits.SelectedItem.Value), int.Parse(ddlPrMedicalLimits.SelectedItem.Value));
                    ...
                    if (dtPRMEDICRATE2.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; dtPRMEDICRATE2.Rows.Count > i; i++)
                        {
                            ...
                            if (int.Parse(ddlPrMedicalLimits.SelectedItem.Value) == int.Parse(myRateList[7].Trim()))
                            {
                                ...
                                //ddlRate.SelectedIndex = ddlRate.Items.IndexOf(
                                //    ddlRate.Items.FindByValue(myRateList[0].Trim()));
                            }
                        }
                    }
                }
                else
                {
                    ...
                    if (dtPRMEDICRATEPRIMARY2.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; dtPRMEDICRATEPRIMARY2.Rows.Count > i; i++)
                        {
                            string value = dtPRMEDICRATEPRIMARY2.Rows[i]["PRMedicalLimitDesc"].ToString().Trim();

                            if (ddlPrMedicalLimits.SelectedItem.Text.Trim() == value.Trim())
                            {
                                ...
                                if (int.Parse(myRateList[0].Trim()) != 0)
                                {
                                    //SetPrimaryRates(index, myRateList); Antes
                                    SetPrimaryRates(index, myRateList);
                                    index = index + 1;
                                    //ddlRate.SelectedIndex = ddlRate.Items.IndexOf(
                                    //    ddlRate.Items.FindByValue(myRateList[0].Trim()));
        ...
        protected void ddlRate_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string myStringPrimary = this.ddlRate.SelectedValue.Trim(); ;

            string[] myPrimaryRateList = myStringPrimary.Split('|');
            //this.HIPrimeryRateID.Value = myPrimaryRateList[0];

            //SetDDLLimit Excess
            string myString = this.ddlRateExcess.SelectedValue.Trim();
            string[] myRateList = myStringPrimary.Split('|');

            //alert(myRateList[0]+"-"+myRateList[1])

            //txtIsoCode.Text = ddlRate.SelectedItem.Value.Trim();

            txtIsoCode.Text = myRateList[1];
            taskControl.PRMedicRATEID = int.Parse(myRateList[0]);
            taskControl.Class = myRateList[2];
            txtClass.Text = myRateList[2];
        ...
        private void Calculate()
        {
            ...
            if (TxtRetroactiveDate.Text != String.Empty)
            {
                ...
                if (CHKCyberEndorsment.Checked)
                {
                    TxtTotalPremium.Text = (double.Parse(TxtTotalPremium.Text.Replace("$", ""))) + double.Parse(txtCyberPremium.Text.Replace("$", "")).ToString("###,###,##0.00");
                    txtTotalPrimary.Text = (double.Parse(TxtTotalPremium.Text.Replace("$", ""))) + double.Parse(txtCyberPremium.Text.Replace("$", "")).ToString("###,###,##0.00");
                }
                //CalculateEndorsementOnlyForQuote();
            }
        }
        ...
        private void GetOthersRates()
        {
            try
            {
                ...
                {
                    //Primary
                    System.Data.DataTable dt1 = TaskControl.Policies.GetPRMEDICRATEPRIMARYByClassAndLimitID("1", int.Parse(ddlPrMedicalLimits.SelectedItem.Value.Trim()));
                    System.Data.DataTable dt2 = TaskControl.Policies.GetPRMEDICRATEPRIMARYByClassAndLimitID("7", int.Parse(ddlPrMedicalLimits.SelectedItem.Value.Trim()));
                    System.Data.DataTable dt3 = TaskControl.Policies.GetPRMEDICRATEPRIMARYByClassAndLimitID("3A", int.Parse(ddlPrMedicalLimits.SelectedItem.Value.Trim()));
                    ...
                    //Excess
                    System.Data.DataTable dt4 = TaskControl.Policies.GetPRMEDICRATEByClassAndLimitID("1", int.Parse(ddlPrMedicalLimits.SelectedItem.Value.Trim()));
                    System.Data.DataTable dt5 = TaskControl.Policies.GetPRMEDICRATEByClassAndLimitID("7", int.Parse(ddlPrMedicalLimits.SelectedItem.Value.Trim()));
                    System.Data.DataTable dt6 = TaskControl.Policies.GetPRMEDICRATEByClassAndLimitID("3A", int.Parse(ddlPrMedicalLimits.SelectedItem.Value.Trim()));
                ...
                if (Session["TaskControl"] != null)
                {
                    ...
                    if (taskControl.Anniversary == "01")
                    {
                        for (int i = 0; i < dtCharge.Rows.Count; i++)
                        {
                            ...
                            {
                                double premium=0.00, totalpremium=0.00, cyberEndorsment=0.00,cancellationAmount;

                                premium = taskControl.TotalPremium;

                                if (txtCyberPremium.Text != "")
                                    cyberEndorsment = double.Parse(txtCyberPremium.Text.Trim());
                                else
                                    cyberEndorsment = 0.00;
                                ...
                                TxtPremium.Text = premium.ToString("###,###.#0").Trim();
                                ...
                                //Db Calculate
                                //double chargePercent = double.Parse(dtCharge.Rows[i]["chargePercent"].ToString());
                                //var decPlaces = (((taskControl.TotalPremium + taskControl.CyberEndorsementPremium) * chargePercent) % 1) * 100;
                                //int rounded = 0;
                            ...
                            else
                            {
                                ...
                                TxtPremium.Text = taskControl.TotalPremium.ToString("###,###.#0").Trim();
                                TxtCancAmount.Text = taskControl.CancellationAmount.ToString("-###,###.#0").Trim();
                                TxtTotalPremium.Text = ((taskControl.TotalPremium + 0 + taskControl.CyberEndorsementPremium) - taskControl.CancellationAmount).ToString("###,###.#0").Trim();
                                txtTotalPrimary.Text = (taskControl.TotalPremium + 0 + taskControl.CyberEndorsementPremium).ToString("###,###.#0").Trim();
                                txtTotalExcess.Text = (taskControl.TotalPremium + 0 + taskControl.CyberEndorsementPremium).ToString("###,###.#0").Trim();
                    ...
                    if (CHKCyberEndorsment.Checked)
                    {
                        txtCyberPremium.Visible = true;
                        lblCyberPremium.Visible = true;
                        //TxtTotalPremium.Text = (double.Parse(TxtTotalPremium.Text.Replace("$", "")) + double.Parse(txtCyberPremium.Text.Replace("$", ""))).ToString("###,###.#0");
                    }
                }
            }
        }
        ...
        protected void ddlGroup_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (taskControl.Bank != "000") //Bank = Group
            {
                ...
                {
                    double ManualPremium = 0.00;
                    taskControl.InvoiceNumber = master.DescuentoExcess.ToString();
                    if (TxtUserPremium.Text.Trim() != "")
                    {
                        ManualPremium = double.Parse(TxtUserPremium.Text); 
                    }
                    //aqui
                    ManualPremium = Math.Round(ManualPremium - (ManualPremium * ((master.DescuentoExcess / 100))), 0);
                    TxtPremium.Text = ManualPremium.ToString("###,##0.00");
                    TxtUserPremium.Text = ManualPremium.ToString("###,##0.00");
                }
            }
            txtInvoiceNumber.Text = taskControl.InvoiceNumber;
        ...
        private void CalculateEndorsement()
        {
            ...
            if (ddlEndoType.SelectedItem.Value == "5")
            {
                if (txtEndoPremium.Text != "")
                {
                    FillDG_AdditialCoverages(txtEndoPremium.Text.Trim());
                    AddCyberEndorsment();
                }
            }
            else if(taskControl.isEndorsement && ddlEndoType.SelectedItem.Value != "4")
            {
        ...
        private XmlDocument GetInsertEndorsementsCyberXml(int TaskControlID)
        {
            TaskControl.Policies taskControl = (TaskControl.Policies)Session["TaskControl"];
            TaskControl.Policies taskControl2 = (TaskControl.Policies)Session["OriginalPolicy"];
            ...
            if (txtEffDt.Text != "")
                DbRequestXmlCooker.AttachCookItem("EffectiveDate", SqlDbType.DateTime, 0, txtEffDt.Text.Trim(), ref cookItems); 
            else
                DbRequestXmlCooker.AttachCookItem("EffectiveDate", SqlDbType.DateTime, 0, DateTime.Now.ToShortDateString(), ref cookItems);

            DbRequestXmlCooker.AttachCookItem("EndorsementPremium", SqlDbType.Float, 0, txtAddCyberEndorsmentPremium.Text.ToString(), ref cookItems);
            ...
            if (txtCyberRetroDate.Text != "")
                DbRequestXmlCooker.AttachCookItem("RetroactiveDate", SqlDbType.DateTime, 0, txtCyberRetroDate.Text.Trim(), ref cookItems); 
            else
                DbRequestXmlCooker.AttachCookItem("RetroactiveDate", SqlDbType.DateTime, 0, DateTime.Now.ToShortDateString(), ref cookItems);
        ...
        private void AddEndorsementCyber(int taskControlID)
        {
            Baldrich.DBRequest.DBRequest Executor = new Baldrich.DBRequest.DBRequest();
            try
            {
                Executor.BeginTrans();
                int a = Executor.Insert("AddEndorsements", this.GetInsertEndorsementsCyberXml(taskControlID));
                Executor.CommitTrans();
            }
            catch (Exception xcp)
            {
        ...
        public static System.Data.DataTable GetEndorsements(int taskControlID)
        {
            DbRequestXmlCookRequestItem[] cookItems =
                new DbRequestXmlCookRequestItem[1];
            ...
            System.Data.DataTable dt = exec.GetQuery("GetEndorsementsByTaskControlID", xmlDoc);
            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    ...
                    case "Edit":
                        ...
                        break;
                    case "Print":
                        if (e.Item.Cells[6].Text == "Cyber Endorsment")
                        {
                            PrintWord("PolicyType = 'PP' and FormName = 'eMed Defense Cyber Endorsement'", false);
                        }
                        else 
                        {
                            throw new Exception("Print is not available for this type of endorsment at this time");
                        }
                        //DataGridGroup.DataSource = null;
                    ...
                    default: //Page
                        ...
                        dtEndorsement.DataSource = (System.Data.DataTable)Session["dtPermission"];
                        dtEndorsement.DataBind();
                        break;
                }
            }
        ...
        protected void txtEndoPremium_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                //TaskControl.Policies taskControl = (TaskControl.Policies)Session["TaskControl"];
                //taskControl.isRecalculated = false;
                //Session["TaskControl"] = taskControl;
                if (txtEndoPremium.Text != "")
                {
                    FillDG_AdditialCoverages(txtEndoPremium.Text.Trim());
        ...
        private void FillDG_AdditialCoverages(string Premium)
        {
            DataTable dt = new DataTable();
            dt.Clear();
            ...
            DataRow CyberEndorsment = dt.NewRow();
            CyberEndorsment["Limit"] = "25,000";
            CyberEndorsment["ISOCode"] = "?????";
            CyberEndorsment["Premium"] = Premium;
            dt.Rows.Add(CyberEndorsment);

            DG_AdditialCoverages.DataSource = null;
            DG_AdditialCoverages.DataBind();

            DG_AdditialCoverages.DataSource = dt;
            DG_AdditialCoverages.DataBind();
            DG_AdditialCoverages.Visible = true;
        }

        private void AddCyberEndorsment()
        {
            TaskControl.Policies taskControl = (TaskControl.Policies)Session["TaskControl"];
           ...
           DataTable dt= null ;
           dt = (DataTable)DG_AdditialCoverages.DataSource;
           taskControl.CyberEndorsementPremium = double.Parse(dt.Rows[0]["Premium"].ToString());
           txtCyberPremium.Text = string.Format("{0:C}",dt.Rows[0]["Premium"].ToString());
           //TxtTotalPremium.Text = string.Format("{0:C}", (taskControl.TotalPremium + double.Parse(dt.Rows[0]["Premium"].ToString())).ToString());


           TxtTotalPremium.Text = (taskControl.TotalPremium + taskControl.Charge + double.Parse(dt.Rows[0]["Premium"].ToString())).ToString();
        ...
        protected void CHKCyberEndorsment_CheckedChanged(object sender, EventArgs e)
        {
            if (CHKCyberEndorsment.Checked)
            {
                lblAddCyberEndorsmentPremium.Visible = true;
            ...
            {
                DG_AdditialCoverages.Visible = false;
                txtCyberPremium.Visible = false;
                lblCyberPremium.Visible = false;
        ...
        protected void DG_AdditialCoverages_ItemCreated(object sender, DataGridItemEventArgs e)
        {
        ...
        protected void DtSearchPayments_ItemCreated(object sender, DataGridItemEventArgs e)
        {
            try
            {
        ...
        protected void txtAddCyberEndorsmentPremium_TextChanged(object sender, EventArgs e)
        {
            if (txtAddCyberEndorsmentPremium.Text != "") 
            {
                FillDG_AdditialCoverages(txtAddCyberEndorsmentPremium.Text.Trim());
                AddCyberEndorsment();
            }
            
        }
        protected void ddlEndoType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlEndoType.SelectedItem.Value == "5")
            {
                CHKCyberEndorsment.Checked = true;
