...
namespace EPolicy
{
    ...
    public partial class CorporatePolicyQuote : System.Web.UI.Page
    {
        ...
        private List<string> PrintMSWord(string Filename, List<string> mergePaths, string ProcessedPath)
        {
            ...
            string FilePath = @"C:\inetpub\wwwroot\PRMdic\Reports\Word\Files\Corporate\" + Filename;
        ...
        public static void AddChargePartialPayments(TaskControl.CorporatePolicyQuote taskControl)
        {
            DbRequestXmlCookRequestItem[] cookItems =
