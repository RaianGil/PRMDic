                ...
                <form id="Pol" method="post" runat="server">
                    ...
                    <div class="container-xl mb-4" style="padding-left:18px; padding-right:18px;">
                        <div class="row">
                            ...
                            <div id="effect" class="ui-widget-header ui-corner-all f-center" style="width: 325px; height: auto; display:none">
                                <div class="col-md-12">
                                    <asp:Label ID="Label49" runat="server" class="fs-lbl-s" Text="Select Rate"></asp:Label>
                                </div>
                                <div class="col-md-12">
                                    <asp:Label ID="Label13" runat="server" class="fs-lbl-s" Text="Specialty:"></asp:Label>
                                </div>
                                <div class="col-md-12">
                                    <asp:DropDownList ID="ddlRate" runat="server" class="form-select fs-txt-s" AutoPostBack="True" OnSelectedIndexChanged="ddlRate_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-12">
                                    <asp:Label ID="Label14" runat="server" Text="Iso Code:" class="fs-lbl-s"></asp:Label>
                                </div>
                                <div class="col-md-12">
                                    <asp:TextBox ID="txtIsoCode" runat="server" class="form-control fs-txt-s"></asp:TextBox>
                                </div>
                                <div class="col-md-12">
                                    <asp:Label ID="Label47" runat="server" Text="Class:" class="fs-lbl-s"></asp:Label>
                                </div>
                                <div class="col-md-12">
                                    <asp:TextBox ID="txtClass" runat="server" class="form-control fs-txt-s"></asp:TextBox>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                ...
                                <div class="row mb-1">
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtRate1" runat="server" class="form-control fs-txt-s"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtRate2" runat="server" class="form-control fs-txt-s"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtRate3" runat="server" class="form-control fs-txt-s"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtRate4" runat="server" class="form-control fs-txt-s"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:textbox id="txtEntryDate" CSSCLASS="form-control fs-txt-s fechaFormat" runat="server" IsDate="True" Columns="30" onclick=""></asp:textbox>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-12">
                                                <asp:DataGrid ID="DtSearchPayments" runat="server" AllowPaging="True" AlternatingItemStyle-BackColor="#BB1509" AlternatingItemStyle-CssClass="HeadForm3" AutoGenerateColumns="False" BackColor="White" BorderColor="#D6E3EA" CellPadding="0" HeaderStyle-BackColor="#5C8BAE"
                                                    ...
                                                    Width="90%" HeaderStyle-ForeColor="white" onitemcreated="DtSearchPayments_ItemCreated">
                                                    <FooterStyle BackColor="Navy" ForeColor="#003399" />
                                                    <EditItemStyle BackColor="White" HorizontalAlign="Center" />
                                                    <SelectedItemStyle BackColor="White" HorizontalAlign="Center" />
                                                    <PagerStyle BackColor="White" CssClass="Numbers" ForeColor="Blue" HorizontalAlign="Left" Mode="NumericPages" PageButtonCount="20" />
