                            ...
                            <div class = "row">
                                <div class = "col-md-12 f-center">
                                        ...
                                        <asp:label id="LblError" class="fs-16" runat="server" Visible="False">Label</asp:label>
									    		...
									    		<asp:datagrid id="searchIndividual" RUNAT="server" WIDTH="795px" BORDERSTYLE="Solid" BORDERWIDTH="1px"
												BORDERCOLOR="#D6E3EA" Height="192px" PageSize="14" ITEMSTYLE-CSSCLASS="HeadForm3" HEADERSTYLE-BACKCOLOR="#5C8BAE"
