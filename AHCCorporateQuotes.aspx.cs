...
namespace EPolicy
{
    ...
    public partial class AHCCorporateQuotes : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (Session["AutoPostBack"] == null)
                {
                    if (!IsPostBack)
                    {
                        ...
                        {
                            /*ddlEsconder1.Visible = false;
                            ddlEsconder2.Visible = false;
                            ...
                            DataTable dtPRPrimaryLimit = LookupTables.LookupTables.GetTable("AHCRates");
                            ...
                            if (taskControl.PrMedicalLimit != null)
                            {
                                ...
                                //ddlMainSpecialty.Items.Clear();
                                //ddlMainSpecialty.DataSource = dtPRMEDICRATE3;
                                ...
                                ////Other SpecialtyA
                                //ddlOtherSpecialtyA.Items.Clear();
                                //ddlOtherSpecialtyA.DataSource = dtPRMEDICRATE3;
                                ...
                                ////Other SpecialtyB
                                //ddlOtherSpecialtyB.Items.Clear();
                                //ddlOtherSpecialtyB.DataSource = dtPRMEDICRATE3;
        ...
        private void EnableControls()
        {
           ...
           // btnBack.Visible = false;
            ...
            txtTotalPrimaryPremium.Enabled = true; //false 08/13/2018
            ...
            txtTotalPrimaryCorporate.Enabled = true; //false 8/13/2018
            ...
            try
            {
               ...
               // btnFoward.Visible = false;
                ...
                if (taskControl.IsPolicy)
                {
                    ...
                    if (taskControl.PolicyType.Trim().Substring(0, 2) == "CP" || taskControl.PolicyType.Trim().Substring(0, 3) == "CPA")
                    {
        ...
        private static DataTable UpdateCorporatePolicyDetailByTaskControlID(int TaskControlID, string PrimaryRate)
        {
            DbRequestXmlCookRequestItem[] cookItems =
                new DbRequestXmlCookRequestItem[2];

            DbRequestXmlCooker.AttachCookItem("TaskControlID", SqlDbType.Int, 0, TaskControlID.ToString(), ref cookItems);
            DbRequestXmlCooker.AttachCookItem("PrimaryRate", SqlDbType.Char, 200, PrimaryRate.ToString(), ref cookItems);
            ...
            DataTable dt = exec.GetQuery("UpdateCorporatePolicyDetailByTaskControlID", xmlDoc);
            return dt;
        }
        ...
        private void FillTextControl()
        {
            ...
            try
            {
               DataTable dtGetIso = TaskControl.CorporatePolicyQuote.GetCorporatePolicyDetailByTaskControlID(taskControl.TaskControlID, taskControl.IsPolicy);

                if(dtGetIso.Rows.Count <= 0)
                    dtGetIso = TaskControl.CorporatePolicyQuote.GetCorporatePolicyDetailByTaskControlID(taskControl.TaskControlID, false);
                Login.Login cp = HttpContext.Current.User as Login.Login;
                ...
                if (taskControl.IsPolicy)
                {
                    ...
                    if (dtGetIso.Rows[0]["IsoCode"].ToString() != "")
                        ddlSpecialty.SelectedIndex = ddlSpecialty.Items.IndexOf(
                            ddlSpecialty.Items.FindByValue(dtGetIso.Rows[0]["IsoCode"].ToString()));

                    if (dtGetIso.Rows[0]["IsoCode"].ToString() != "")
                        ddlIsoCode.SelectedIndex = ddlIsoCode.Items.IndexOf(
                            ddlIsoCode.Items.FindByValue(dtGetIso.Rows[0]["IsoCode"].ToString()));
                    ...
                    if (dtGetIso.Rows.Count != 0)
                    {
                        for (int i = 0; i < ddlSpecialty.Items.Count; i++)
                        {
                            if (ddlSpecialty.Items[i].Value.Trim() != "")
                            {
                                ...
                                if (int.Parse(dtGetIso.Rows[0]["IsoCode"].ToString()) == int.Parse(array[0]))
                                {
                                    ddlSpecialty.SelectedIndex = ddlSpecialty.Items.IndexOf(
               ...
               //
                ...
                if (taskControl.Mode != 1)
                {
                    ...
                    //    ddlPrMedicalLimits.SelectedIndex = ddlPrMedicalLimits.Items.IndexOf(ddlPrMedicalLimits.Items.FindByText("100,000/300,000"));
                        //
                    else if ((taskControl.PolicyType.Trim() == "CPA" || taskControl.PolicyType.Trim() == "APC") && DtGridCorpaoratePol.Items.Count > 0)
                    {
            ...
            //{
                for (int n = 0; n < int.Parse(TxtAddQuantity.Text); n++)
                {
                    try
                    {
                        ...
                        myRow["Specialty"] = ddPrimarylPolicyClass.SelectedItem.Text.Trim();
            ...
            try
            {
                switch (e.CommandName)
                {
                    case "Select": //Edit
                        ...
                        SetDDLLimit(1, int.Parse(ddlPrimaryLimits1.SelectedItem.Value));

                        ddPrimarylPolicyClass.SelectedIndex = ddPrimarylPolicyClass.Items.IndexOf(ddPrimarylPolicyClass.Items.FindByText(e.Item.Cells[5].Text.Trim()));
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // ArrayList errorMessages = new ArrayList();
                ...
                {
                     if (taskControl.PolicyType.Trim() == "CPA")
                    {
                        ...
                        if (taskControl.Anniversary == "01")
                        {
                            ...
                            else if (!taskControl.PrintPolicy && DateTime.Parse(taskControl.EffectiveDate.Trim()) >= DateTime.Parse("08/01/2015"))
                            {
                                ...
                                //rpt = new EPolicy2.Reports.PRMdic.InvoiceAllied(taskControl, false);//Ruben
        ...
        private void ExportFileFromActiveXViewer(ActiveReport3 rpt)
        {
            ...
            if (taskControl != null)
                if (taskControl.TaskControlTypeID == 12 || taskControl.TaskControlTypeID == 18 || taskControl.TaskControlTypeID == 24)
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Session["TaskControl"] = taskControl;
                DataTable dt = GetCorporatePolicyByTaskControlID(taskControl.TaskControlID, taskControl.IsPolicy);

                DataTable dtUpdate = null;
                
                if(taskControl.IsPolicy == false)
                    dtUpdate = UpdateCorporatePolicyDetailByTaskControlID(taskControl.TaskControlID, taskControl.PrMedicalLimit.Trim());
                else
                   dtUpdate = UpdateCorporatePolicyDetailByTaskControlID(taskControl.TaskControlID, dt.Rows[0]["PrMedicalLimit"].ToString());
        ...
        protected void ddlPolicyClass_SelectedIndexChanged1(object sender, EventArgs e)
        {
            ...
            //Primary
            //DataTable dtPRMEDICRATEPRIMARY2 = EPolicy.TaskControl.Application.GetPRMEDICRATEPRIMARYAHCBYISOCODE(int.Parse(HIPrimeryRateID.Value), txtIsoCode.Text.Trim());
            //if (dtPRMEDICRATEPRIMARY2.Rows.Count > 0)
            //{
            //    int index = 1;
            //    for (int i = 0; dtPRMEDICRATEPRIMARY2.Rows.Count > i; i++)
        ...
        private void GetOthersRates()
        {
            ...
            {
                //Primary
                DataTable dt1 = TaskControl.CorporatePolicyQuote.GetPRMEDICRATEPRIMARYByClassAndLimitID("", int.Parse(ddlPrimaryLimits1.SelectedItem.Value.Trim()));
                DataTable dt2 = TaskControl.CorporatePolicyQuote.GetPRMEDICRATEPRIMARYByClassAndLimitID("", int.Parse(ddlPrimaryLimits1.SelectedItem.Value.Trim()));
                DataTable dt3 = TaskControl.CorporatePolicyQuote.GetPRMEDICRATEPRIMARYByClassAndLimitID("", int.Parse(ddlPrimaryLimits1.SelectedItem.Value.Trim()));
        ...
        protected void btnConvertPrimary_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                taskControl.Mode = 1; //ADD
                taskControl.PolicyClassID = 20;
                taskControl.TaskControlTypeID = 24;
                ...
                taskControl.Term = 12;
              //  taskControl.PriPolLimits1 = ddlPrimaryLimits1.SelectedIndex;
                ...
                try
                {
                    Response.Redirect("AHCCorporateQuotes.aspx", true);
                }
                catch
                {
                }
        ...
        {
            RemoveSessionLookUp();
            Session.Add("FromUI", "AHCCorporateQuotes.aspx");
        ...
        protected void DtSearchPayments_ItemCommand1(object source, DataGridCommandEventArgs e)
        {
            ...
            if (e.Item.ItemType.ToString() != "Pager") // Select
            {
                ...
                Session.Clear();
                Session["TaskControl"] = taskControl;
                Response.Redirect("AHCCorporateQuotes.aspx?" + taskControl.TaskControlID, true);
            }
            else  // Pager
            {
        ...
        protected void btnHistory_Click(object sender, System.EventArgs e)
        {
            if (Session["TaskControl"] != null)
            {
                RemoveSessionLookUp();
                TaskControl.CorporatePolicyQuote taskControl = (TaskControl.CorporatePolicyQuote)Session["TaskControl"];
                Response.Redirect("SearchAuditItems.aspx?type=32&taskControlID=" +
        ...
        private void PrintNewEndorsement(string FileName, bool CP)
        {
            try
            {
                ...
                viewer.ProcessingMode = ProcessingMode.Local;
                if(CP)
                    viewer.LocalReport.ReportPath = Server.MapPath("Reports/ExclusionEndorsement2.rdlc");//Server.MapPath("Reports/ExclusionEndorsement2.rdlc");
                else
