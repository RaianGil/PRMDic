...
namespace EPolicy.Customer
{
    public class Registry
    {
       ...
       // private string      _GoodStandingGradDate = "";
        ...
        private bool         _JuntaLicenciamiento = false;
        ...
        public bool JuntaLicenciamiento
        {
            get
            {
                return this._JuntaLicenciamiento; 
            }
            set
            {
                this._JuntaLicenciamiento = value; 
            }
        }
		...
		private XmlDocument GetInsertRegistryXml()
		{
            ...
            DbRequestXmlCooker.AttachCookItem("JuntaLicenciamiento",
                SqlDbType.Bit, 0, this.JuntaLicenciamiento.ToString(),
                ref cookItems);
		...
		private void History(int mode, int userID, int taskControlID)
		{
			...
			if(mode == 2)
			{
                ...
                history.BuildNotesForHistory("Certificado Junta Licenciamiento", oldRegistry.JuntaLicenciamiento.ToString(), this.JuntaLicenciamiento.ToString(), mode);
                ...
                history.BuildNotesForHistory("Shareholder Qty.", oldRegistry.ShareholderNo.ToString(), this.ShareholderNo.ToString(), mode);
		...
		private static Registry FillProperties(Registry registry)
		{
            ...
            registry.InternGradDate = (registry._dtRegistry.Rows[0]["InternGradDate"] != System.DBNull.Value) ? (string)registry._dtRegistry.Rows[0]["InternGradDate"].ToString() : "";
            ...
            registry.MDSGradDate = (registry._dtRegistry.Rows[0]["MDSGradDate"] != System.DBNull.Value) ? (string)registry._dtRegistry.Rows[0]["MDSGradDate"] : "";
            registry.JuntaLicenciamiento = (registry._dtRegistry.Rows[0]["JuntaLicenciamiento"] != System.DBNull.Value) ? bool.Parse(registry._dtRegistry.Rows[0]["JuntaLicenciamiento"].ToString()) : false;
            registry.LicenciaDate = (registry._dtRegistry.Rows[0]["LicenciaDate"] != System.DBNull.Value) ? (string)registry._dtRegistry.Rows[0]["LicenciaDate"] : "";
            registry.Licencia = (registry._dtRegistry.Rows[0]["Licencia"] != System.DBNull.Value) ? (string)registry._dtRegistry.Rows[0]["Licencia"] : "";
            ...
            registry.ResidencyGradDate = (registry._dtRegistry.Rows[0]["ResidencyGradDate"] != System.DBNull.Value) ? (string)registry._dtRegistry.Rows[0]["ResidencyGradDate"] : "";
            ...
            //registry.GoodStandingGradDate = (registry._dtRegistry.Rows[0]["GoodStandingGradDate"] != System.DBNull.Value) ? (string)registry._dtRegistry.Rows[0]["GoodStandingGradDate"] : "";
            ...
            registry.ShareholderNo = (registry._dtRegistry.Rows[0]["ShareholderNo"] != System.DBNull.Value) ? (string)registry._dtRegistry.Rows[0]["ShareholderNo"] : "";
            ...
            registry.FellowshipGradDate = (registry._dtRegistry.Rows[0]["FellowshipGradDate"] != System.DBNull.Value) ? (string)registry._dtRegistry.Rows[0]["FellowshipGradDate"] : "";
