...
<HTML>
	...
	<body>
		<form id="CancPol" name="CanPol" method="post" runat="server">
              ...
              <div class="container-xl mb-4" style="padding-left:18px; padding-right:18px;">
                <div class="row">
                   ...
                   <div class="col-md-8" style="text-align:right;">
                        ...
                        <asp:button id="BtnSave" runat="server" CssClass="btn-bg-theme2 btn-h-30 btn-r-4" Text="Save" onclick="BtnSave_Click"
                           onclientclick="return confirm('Are you certain you want to apply this Cancellation?');"></asp:button>
                   ...
                   <hr />
                        <div class="row">
                           <div class="col-md-4">
                                <div class="mb-3 row">
             		                <asp:label id="Label26" RUNAT="server" ENABLEVIEWSTATE="False"  Font-Names="Tahoma" HEIGHT="19px" CSSCLASS="col-md-4 col-form-labe fs-lbl-s"
			    		            	Font-Size="9pt">Cancellation Date</asp:label>
                                    <div class="col-md-8">
                                        <asp:TextBox id="txtCancellationDate" onclick="ShowDateTimePicker();" CSSCLASS="form-control fs-txt-s fs-txt-s" RUNAT="server" ISDATE="True"></asp:TextBox>
                                    </div>
                                </div>
                           </div>
                           <div class="col-md-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                        <asp:dropdownlist id="ddlCancellationReason" RUNAT="server" AutoPostBack="True" CssClass="form-select fs-txt-s"
                                            onselectedindexchanged="ddlCancellationReason_SelectedIndexChanged" ></asp:dropdownlist>
                                    </div>
                                </div>
                           </div>
                           <div class="col-md-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                        <maskedinput:maskedtextbox id="txtRSCDate" onclick="ShowDateTimePicker2();" CSSCLASS="form-control fs-txt-s" RUNAT="server" ISDATE="True" ></maskedinput:maskedtextbox>
                                    </div>
                                </div>
                           </div>
                           ...
                           <div class="col-md-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                        <asp:dropdownlist id="ddlCancellationMethod" RUNAT="server" AutoPostBack="True" CSSCLASS="form-select fs-txt-s"
                                            onselectedindexchanged="ddlCancellationMethod_SelectedIndexChanged"></asp:dropdownlist>
                                    </div>
                                </div>
                           </div>
                           <div class="col-md-4">
                           ...
                           <div class="col-md-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                        <maskedinput:maskedtextbox id="TxtCancellationEntryDate" onclick="ShowDateTimePicker3();" CSSCLASS="form-control fs-txt-s" RUNAT="server" ISDATE="True"></maskedinput:maskedtextbox>
                                    </div>
                                </div>
                           </div>
                        </div>
			...
			<INPUT id="ConfirmDialogBoxPopUp" style="Z-INDEX: 118; LEFT: 440px; WIDTH: 35px; POSITION: absolute; TOP: 14px; HEIGHT: 22px"
				type="hidden" size="1" value="false" name="ConfirmDialogBoxPopUp" runat="server">
