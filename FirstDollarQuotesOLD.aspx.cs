...
public partial class FirstDollarQuotes : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txtExcessRetroDate.Visible = false;
            ...
            DataTable dtPRPrimaryLimit = LookupTables.GetTable("PRFirstDollarLimit");
            ...
            ddlLimits.Items.Remove(ddlLimits.Items.FindByValue("10"));
            ddlLimits.Items.Remove(ddlLimits.Items.FindByValue("12"));
            ddlLimits.Items.Remove(ddlLimits.Items.FindByValue("13"));
            ddlLimits.Items.Remove(ddlLimits.Items.FindByValue("11"));
            ddlLimits.Items.Remove(ddlLimits.Items.FindByValue("6")); //300,000/1,000,000 Ya no se ofrece.
            //ddlLimits.Items.Remove(ddlLimits.Items.FindByValue("3"));
            ddlLimits.Items.Remove(ddlLimits.Items.FindByValue("11"));
            // ddlLimits.Items.Remove(ddlLimits.Items.FindByValue("7"));
            ...
            ddlLimits2.Items.Remove(ddlLimits2.Items.FindByValue("10"));
            ddlLimits2.Items.Remove(ddlLimits2.Items.FindByValue("12"));
            ddlLimits2.Items.Remove(ddlLimits2.Items.FindByValue("13"));
            ddlLimits2.Items.Remove(ddlLimits2.Items.FindByValue("11"));
            ddlLimits2.Items.Remove(ddlLimits2.Items.FindByValue("6")); //300,000/1,000,000 Ya no se ofrece.
            //  ddlLimits2.Items.Remove(ddlLimits2.Items.FindByValue("3"));
            ddlLimits2.Items.Remove(ddlLimits2.Items.FindByValue("11"));
            //ddlLimits2.Items.Remove(ddlLimits2.Items.FindByValue("7"));
            ...
            ddlLimits3.Items.Remove(ddlLimits3.Items.FindByValue("10"));
            ddlLimits3.Items.Remove(ddlLimits3.Items.FindByValue("12"));
            ddlLimits3.Items.Remove(ddlLimits3.Items.FindByValue("13"));
            ddlLimits3.Items.Remove(ddlLimits3.Items.FindByValue("11"));
            ddlLimits3.Items.Remove(ddlLimits3.Items.FindByValue("6")); //300,000/1,000,000 Ya no se ofrece.
            // ddlLimits3.Items.Remove(ddlLimits3.Items.FindByValue("3"));
            ddlLimits3.Items.Remove(ddlLimits3.Items.FindByValue("11"));
            // ddlLimits3.Items.Remove(ddlLimits3.Items.FindByValue("7"));
            ...
            ddlLimits4.Items.Remove(ddlLimits4.Items.FindByValue("10"));
            ddlLimits4.Items.Remove(ddlLimits4.Items.FindByValue("12"));
            ddlLimits4.Items.Remove(ddlLimits4.Items.FindByValue("13"));
            ddlLimits4.Items.Remove(ddlLimits4.Items.FindByValue("11"));
            ddlLimits4.Items.Remove(ddlLimits4.Items.FindByValue("6")); //300,000/1,000,000 Ya no se ofrece.
            // ddlLimits4.Items.Remove(ddlLimits4.Items.FindByValue("3"));
            ddlLimits4.Items.Remove(ddlLimits4.Items.FindByValue("11"));
            //ddlLimits4.Items.Remove(ddlLimits4.Items.FindByValue("7"));
            ...
            ddlLimits5.Items.Remove(ddlLimits5.Items.FindByValue("10"));
            ddlLimits5.Items.Remove(ddlLimits5.Items.FindByValue("12"));
            ddlLimits5.Items.Remove(ddlLimits5.Items.FindByValue("13"));
            ddlLimits5.Items.Remove(ddlLimits5.Items.FindByValue("11"));
            ddlLimits5.Items.Remove(ddlLimits5.Items.FindByValue("6")); //300,000/1,000,000 Ya no se ofrece.
            // ddlLimits5.Items.Remove(ddlLimits5.Items.FindByValue("3"));
            ddlLimits5.Items.Remove(ddlLimits5.Items.FindByValue("11"));
            // ddlLimits5.Items.Remove(ddlLimits5.Items.FindByValue("7"));
            ...
            ddlLimits6.Items.Remove(ddlLimits6.Items.FindByValue("10"));
            ddlLimits6.Items.Remove(ddlLimits6.Items.FindByValue("12"));
            ddlLimits6.Items.Remove(ddlLimits6.Items.FindByValue("13"));
            ddlLimits6.Items.Remove(ddlLimits6.Items.FindByValue("11"));
            ddlLimits6.Items.Remove(ddlLimits6.Items.FindByValue("6")); //300,000/1,000,000 Ya no se ofrece.
            //  ddlLimits6.Items.Remove(ddlLimits6.Items.FindByValue("3"));
            ddlLimits6.Items.Remove(ddlLimits6.Items.FindByValue("11"));
            // ddlLimits6.Items.Remove(ddlLimits6.Items.FindByValue("7"));

            //PRPrimaryLimit
            ddlPrimaryLimits1.DataSource = dtPRPrimaryLimit;
            ddlPrimaryLimits1.DataTextField = "PRFirstDollarLimitDesc";
            ddlPrimaryLimits1.DataValueField = "PRFirstDollarLimitID";  	
                ...
                if (Session["TaskControl"] != null)
                {
                    ...
                    switch (taskControl.ApplicationMode)
                    {
                        case "ADD":
                            ...
                            if (!cp.IsInRole("LIMITEDAGENCY"))
                            {
                                ddlAgency.Items.Remove(ddlAgency.Items.FindByValue("002"));
                                ddlAgency.Items.Remove(ddlAgency.Items.FindByValue("008"));
                                ddlAgency.Items.Remove(ddlAgency.Items.FindByValue("021"));
                                ddlAgency.Items.Remove(ddlAgency.Items.FindByValue("006"));
                                ddlAgency.Items.Remove(ddlAgency.Items.FindByValue("002"));
                            }
                            break;
    ...
    private void FillTextControl()
    {
        ...
        //txtExcCarierName1.Text = taskControl.ExcCarierName1; MEDMAL
        ...
        //txtExcessRetroDate.Text = taskControl.ExcessRetroDate; medmal

        if (taskControl.IsPrimary)
        {
            RadioButton1.Checked = true;
            //RadioButton2.Checked = false; medmal
        }
        else
        {
    ...
    private void Save(bool IsNavigation)
    {
        ...
        try
        {
            ...
            if (ddPrimarylPolicyClass.SelectedItem.Value.Trim() == "")
            {
    ...
    private void ValidateFields()
    {
        ...
        try
        {
            ...
            //{
            //    errorMessages.Add("The Excess Retro Date is Missing or wrong." + "\r\n");
            //}
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        string test = taskControl.Residency;
        ...
        Session.Add("FromPage", "FirstDollarQuotes.aspx");
    ...
    protected void btnConvert_Click(object sender, EventArgs e)
    {
        ...
        taskControl.InsuranceCompany = taskControlQuote.Residency;
        ...
        if (taskControl.InsuranceCompany == "002")
            taskControl.PolicyType = "AAE";
        else
            taskControl.PolicyType = "PE";
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        sentEmail = false;
        string specialty = ddPrimarylPolicyClass.SelectedItem.Text.ToString();
        if (!sentEmail)
        {
        ...
        ///ddlAgent.SelectedItem.Value
    }
    protected void ddlLimits_SelectedIndexChanged(object sender, EventArgs e) //Excess
    {
        SetAllRate();
    }
    ...
    private void SetAllRate()
    {
        try
        {
            if (RadioButton1.Checked == false) // && RadioButton2.Checked == false) MEDMAL
            {
                throw new Exception("Please select The Rate Type (Primary).");
            }
    ...
    private void GetAllRates()
    {
        ...
        if (SaveBeforeRate(false))
        {
            ...
            hdfLimit.Value = limit.ToString();
            hdfPrimaryLimit.Value = primaryLimit.ToString();
        }
        else
        {
            ddlLimits.SelectedIndex = -1;
    ...
    private bool SaveBeforeRate(bool IsNavigation)
    {
        ...
        try
        {
            ...
            DataTable dtExistCount = GetCustomerExistCount(TxtFirstName.Text.Trim(), txtLastname1.Text.Trim(), txtLastname2.Text.Trim());
            DataTable dtExist = GetCustomerExist(TxtFirstName.Text.Trim(), txtLastname1.Text.Trim(), txtLastname2.Text.Trim());

            if (dtExistCount.Rows.Count > 0)
            {
                taskControl.Customer.CustomerNo = dtExist.Rows[0]["CustomerNo"].ToString().Trim();
                taskControl.Customer.ProspectID = int.Parse(dtExist.Rows[0]["ProspectID"].ToString().Trim());
            }
    ...
    private void SetDDLLimit(int LimitID, int primaryLimit)
    {
        ...
        //Primary
        DataTable dtPRMEDICRATE2 = GetPRMEDICRATEFIRSTDOLLAR(primaryLimit);
    ...
    protected void ddlPolicyClass_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        DataTable dtPRMEDICRATE2 = GetPRMEDICRATEFIRSTDOLLAR(int.Parse(hdfPrimaryLimit.Value));

        //SetddlPimaryPolicyClass
        ddPrimarylPolicyClass.SelectedIndex = ddPrimarylPolicyClass.Items.IndexOf(
            ddPrimarylPolicyClass.Items.FindByText(this.ddPrimarylPolicyClass.SelectedItem.Text.Trim()));
        ...
        //SetDDLLimit Excess
        string myString = this.ddPrimarylPolicyClass.SelectedValue.Trim();
        string[] myRateList = myString.Split('|');
        //alert(myRateList[0]+"-"+myRateList[1])

        for (int i = 0; i < dtPRMEDICRATE2.Rows.Count; i++)
        {

            if (dtPRMEDICRATE2.Rows[i]["PRMEDICRATEDesc"].ToString().Trim() == this.ddPrimarylPolicyClass.SelectedItem.Text.Trim())
            {

            this.txtPrateID.Value = dtPRMEDICRATE2.Rows[i]["PRMEDICRATEID"].ToString(); //  myRateList[i];
            this.HIIsoCode.Value = dtPRMEDICRATE2.Rows[i]["IsoCode"].ToString(); // myRateList[1];
            this.HIClass.Value = dtPRMEDICRATE2.Rows[i]["Class"].ToString(); //myRateList[2];
            this.HIRate1.Value = dtPRMEDICRATE2.Rows[i]["RateYear1"].ToString(); //myRateList[3];
            this.HIRate2.Value = dtPRMEDICRATE2.Rows[i]["RateYear2"].ToString(); //myRateList[4];
            this.HIRate3.Value = dtPRMEDICRATE2.Rows[i]["RateYear3"].ToString();  //myRateList[5];
            this.HIRate4.Value = dtPRMEDICRATE2.Rows[i]["MCMRate"].ToString(); //myRateList[6];

            this.txtIsoCode.Text = dtPRMEDICRATE2.Rows[i]["IsoCode"].ToString(); // myRateList[1];
            this.txtClass.Text = dtPRMEDICRATE2.Rows[i]["Class"].ToString(); //myRateList[2];
            this.txtRate1.Text = dtPRMEDICRATE2.Rows[i]["RateYear1"].ToString(); //myRateList[3];
            this.txtRate2.Text = dtPRMEDICRATE2.Rows[i]["RateYear2"].ToString(); //myRateList[4];
            this.txtRate3.Text = dtPRMEDICRATE2.Rows[i]["RateYear3"].ToString();  //myRateList[5];
            this.txtRate4.Text = dtPRMEDICRATE2.Rows[i]["MCMRate"].ToString(); //myRateList[6];

            //this.txtPrateID.Value = myRateList[i];
        ...
        //        {
        //            SetOtherRateFields(i, myRateList);
        //            index = index + 1;
        //        }
        //    }
        //}
        ...
        //Primary
        DataTable dtPRMEDICRATEPRIMARY2 = GetPRMEDICRATEFIRSTDOLLARBYISOCODE(int.Parse(this.txtPrateID.Value), txtIsoCode.Text.Trim());
        if (dtPRMEDICRATEPRIMARY2.Rows.Count > 0)
        {
            ...
            for (int i = 0; dtPRMEDICRATEPRIMARY2.Rows.Count > i; i++)
            {
                ...
                if (int.Parse(ddPrimarylPolicyClass.SelectedItem.Value.Trim()) == int.Parse(myRateList[0]) && ddlPrimaryLimits1.SelectedItem.Value.Trim() == myRateList[7])
                {
    ...
    private void SetPremiumByRetroDate(DateTime entrydate)
    {
        ...
        //ExcessRetroYear = entrydate.Year - DateTime.Parse(txtExcessRetroDate.Text.Trim()).Year; MEDMAL
    ...
    protected void ddlPrimaryLimits1_SelectedIndexChanged(object sender, EventArgs e) //Primary
    {
        SetAllRate();
    }
    protected void btnConvertPrimary_Click(object sender, EventArgs e)
    {
        ...
        taskControl.TaskControlTypeID = 27;
        taskControl.Term = 12;
        taskControl.OriginatedAt = 1;
        taskControl.PRMedicalLimit = ddlPrimaryLimits1.SelectedIndex;
        ...
        //if (taskControl.InsuranceCompany == "002")
        //    taskControl.PolicyType = "AAP";
        //else
        //    taskControl.PolicyType = "PAH";
        taskControl.PolicyType = "IF";

        string limite = ddlPrimaryLimits1.SelectedItem.Value.ToString();
        taskControl.ApplicationID = taskControlQuote.TaskControlID;
        taskControl.TotalPremium = taskControlQuote.PRateYear1;
        taskControl.PRMedicRATEID = taskControlQuote.PRPrimeryRateID;
        taskControl.PRMedicalLimit = int.Parse(limite); //taskControlQuote.PRPrimaryLimitID;
        taskControl.IsoCode = taskControlQuote.IsoCode;
        taskControl.Class = taskControlQuote.ClassRate;
        ...
        taskControl.EntryDate = taskControlQuote.EntryDate;
    ...
    private static DataTable GetCustomerExist(string FirstName, string LastName, string LastName2)
    {
        DbRequestXmlCookRequestItem[] cookItems =
            new DbRequestXmlCookRequestItem[3];

        DbRequestXmlCooker.AttachCookItem("FirstName",
            SqlDbType.VarChar, 100, FirstName.ToString(),
            ref cookItems);


        DbRequestXmlCooker.AttachCookItem("LastName",
            SqlDbType.VarChar, 100, LastName.ToString(),
            ref cookItems);


        DbRequestXmlCooker.AttachCookItem("LastName2",
            SqlDbType.VarChar, 100, LastName2.ToString(),
            ref cookItems);
        ...
        try
        {
            dt = exec.GetQuery("GetCustomerExist", xmlDoc);
            return dt;
        }
        catch (Exception ex)
        {
    ...
    private static DataTable GetCustomerExistCount(string FirstName, string LastName, string LastName2)
    {
        DbRequestXmlCookRequestItem[] cookItems =
            new DbRequestXmlCookRequestItem[3];
        ...
        try
        {
            dt = exec.GetQuery("GetCustomerExistCount", xmlDoc);
            return dt;
        }
        catch (Exception ex)
        {
