...
namespace EPolicy
{
    ...
    public partial class FirstDollarCorporate : System.Web.UI.Page
    {
                ...
                if (Session["AutoPostBack"] == null)
                {
                    if (!IsPostBack)
                    {
                        if (Session["TaskControl"] != null)
                        {
                            ...
                            DataTable dtPRPrimaryLimit = LookupTables.LookupTables.GetTable("PRFirstDollarLimit");
                            ...
                            DataTable dtPRMEDICRATE2 = GetPRMEDICRATEFIRSTDOLLAR(1);
                            ...
                            //ddlEndoType.Items.Remove(ddlEndoType.Items.FindByText("Cyber Endorsment"));
                            //ddlEndoType.Items.Insert(0, "");

                            //Main Specialty
                            ddlMainSpecialty.Items.Clear();
                            ddlMainSpecialty.DataSource = dtPRMEDICRATE2;
                            ddlMainSpecialty.DataTextField = "PRMEDICRATEDesc";
                            ddlMainSpecialty.DataValueField = "PRMEDICRATEID";
                            ...
                            ddlOtherSpecialtyA.DataTextField = "PRMEDICRATEDesc";
                            ddlOtherSpecialtyA.DataValueField = "PRMEDICRATEID";
                            ...
                            ddlOtherSpecialtyB.DataTextField = "PRMEDICRATEDesc";
                            ddlOtherSpecialtyB.DataValueField = "PRMEDICRATEID";
        ...
        private void EnableControls()
        {
           ...
           // btnBack.Visible = false;
            ...
            if (taskControl.IsPolicy)
            {
                ...
                if (taskControl.PolicyType.Trim().Substring(0, 2) == "CF")
                {
            ...
            //this.DtGridCorpaoratePol.Columns[7].Visible = true; //aqui
        ...
        private void DisableControls()
        {
            ...
            try
            {
               ...
               // TxtProspectNo.Enabled = false;
                ...
                //this.DtGridCorpaoratePol.Columns[9].Visible = false; aqui
            ...
            try
            {
                ...
                if (taskControl.IsPolicy)
                {
                    ...
                    if (taskControl.PriPolLimits1 != "" && taskControl.PriPolLimits1 != null)
                    {
                        ...
                        else if (taskControl.PriPolLimits1 == "1,000,000/3,000,000")
                            taskControl.PriPolLimits1 = "1,000,000/3,000,000";
                ...
                if (taskControl.Mode != 1)
                {
                    ...
                    //else if (taskControl.PolicyType.Trim() == "CF" && taskControl.PolicyNo.Trim() == "60347")
                    //    ddlPrMedicalLimits.SelectedIndex = ddlPrMedicalLimits.Items.IndexOf(ddlPrMedicalLimits.Items.FindByText("100,000/300,000"));
                        //
                    else if ((taskControl.PolicyType.Trim() == "CF" || taskControl.PolicyType.Trim() == "APC") && DtGridCorpaoratePol.Items.Count > 0)
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (TxtAddQuantity.Text != "1" && txtCustomerName2.Text != String.Empty) 
            {
            ...
            else
            {
                for (int n = 0; n < int.Parse(TxtAddQuantity.Text); n++)
                {
                    try
                    {
                        ...
                        myRow["Specialty"] = ddPrimarylPolicyClass.SelectedItem.Text.Trim();//ddlPolicyClass.SelectedItem.Text.Trim();
                        ...
                        {
                            totPprem = totPprem + double.Parse(DtGridCorpaoratePol.Items[i].Cells[6].Text);
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // ArrayList errorMessages = new ArrayList();
                ...
                {
                     if (taskControl.PolicyType.Trim() == "CF")
                    {
                    ...
                    else if (taskControl.PolicyType.Trim() == "APC")
                    {
                        ...
                        else //Renovacion.
                        {
                            ...
                            if (!taskControl.PrintPolicy) //Proof that the renovation was printed.
                            {
                                ...
                                rpt2 = new EPolicy2.Reports.PRMdic.RenewalEndorsement(taskControl, DtGridCorpaoratePol.Items.Count, limit);
                                rpt2.Document.Printer.PrinterName = "";
                                rpt2.Run();
                                rpt.Document.Pages.InsertRange(rpt.Document.Pages.Count, rpt2.Document.Pages);
                    ...
                    else
                    {
                        if (DtGridCorpaoratePol.Items.Count > 0)
                        {
                            ...
                            DataDynamics.ActiveReports.ActiveReport3 rpt = new EPolicy2.Reports.PRMdic.CorporateQuotes(taskControl, txtERate150_200.Text,
                            txtERate1M_3M.Text, txtERate250_500.Text, txtERate400_700.Text, txtERate500_1M.Text,
                            txtPRate.Text, txtTotPremTN6.Text, "0", txtDiscountP.Text, "0",
                            DtGridCorpaoratePol.Items.Count, specialty, isoCode);
                    ...
                    if (taskControl.PolicyType.Trim() == "CF")
                    {
                        ...
                        else //Renovacion.
                        {
                            ...
                            if (!taskControl.PrintPolicy) //Proof that the renovation was printed.
                            {
                                ...
                                PrintNewEndorsement(_FileName, false); //estaba false
        ...
        private void ExportFileFromActiveXViewer(ActiveReport3 rpt)
        {
            ...
            if (taskControl != null)
                if (taskControl.TaskControlTypeID == 28)
        ...
        private void ValidateFields()
        {
            ...
            try
            {
                ...
                //else 
                //{
                //    if (this.txtTotalExcessCorporate.Text.Trim() == "" || double.Parse(this.txtTotalExcessCorporate.Text.Trim()) == 0)
                //    {
                //        errorMessages.Add("Yor have to calculate or Verify the fileds. " + "\r\n");
                //    }
                //}
        ...
        protected void ddlPolicyClass_SelectedIndexChanged1(object sender, EventArgs e)
        {
            ...
            dtrate = GetPRMEDICRATEFIRSTDOLLAR(int.Parse(ddlPrimaryLimits1.SelectedItem.Value));

            string rateid = "", isocode = "";

            for (int i = 0; i < dtrate.Rows.Count; i++)
            {
                if (dtrate.Rows[i]["PRMEDICRATEID"].ToString() == this.ddPrimarylPolicyClass.SelectedValue.Trim())
                {
                    rateid = dtrate.Rows[i]["PRMEDICRATEID"].ToString() ;
                    isocode = dtrate.Rows[i]["IsoCode"].ToString();
                }
            }
            ...
            this.txtPrateID.Value = rateid;//myRateList[0];
            this.txtIsoCode.Text = isocode;//myRateList[1];
        ...
        private void SetDDLLimit(int LimitID, int primaryLimit) //aqui 
        {
            ...
            //DataTable dtPRMEDICRATE1 = GetPRMEDICRATEFIRSTDOLLAR(primaryLimit);//EPolicy.TaskControl.Application.GetPRMEDICRATE(LimitID);
            //ddlPolicyClass.Items.Clear();
        ...
        //aqui
            ...
            ddPrimarylPolicyClass.SelectedIndex = ddPrimarylPolicyClass.Items.IndexOf(
                ddPrimarylPolicyClass.Items.FindByText(this.ddlMainSpecialty.SelectedItem.Text.Trim()));
        ...
        protected void btnConvertPrimary_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    Response.Redirect("FirstDollarCorporate.aspx", true);
                }
                catch
                {
                }
        ...
        {
            RemoveSessionLookUp();
            Session.Add("FromUI", "FirstDollarCorporate.aspx");
        ...
        protected void DtSearchPayments_ItemCommand1(object source, DataGridCommandEventArgs e)
        {
            ...
            if (e.Item.ItemType.ToString() != "Pager") // Select
            {
                ...
                Session.Clear();
                Session["TaskControl"] = taskControl;
                Response.Redirect("FirstDollarCorporate.aspx?" + taskControl.TaskControlID, true);
            }
            else  // Pager
            {
        ...
        private void PrintNewEndorsement(string FileName, bool CP)
        {
            try
            {
                ...
                mergePaths.Add(PrintWordProcessedPath("PolicyType = '" + taskControl.PolicyType + "' and FormName = 'ExclusionEndorsement'", false));
        ...
        protected void ObtainTotalPremiumsForReport()
        {
            for (int n = 0; n < DtGridCorpaoratePol.Items.Count; n++)
            {
                ...
                //SetDDLLimit(int.Parse(ddlLimits.SelectedItem.Value), int.Parse(ddlPrimaryLimits1.SelectedItem.Value));
                SetDDLLimit(0, int.Parse(ddlPrimaryLimits1.SelectedItem.Value));
        ...
        private List<string> PrintMSWord(string Filename, List<string> mergePaths, string ProcessedPath)
        {
            ...
            string FilePath = @"C:\inetpub\wwwroot\PRMdic\Reports\Word\Files\FirstDollarCorporate\" + Filename;
        ...
        private string GetBookMarkValue(string BookMarkName)
        {
            ...
            if (BookMarkName == "AggregateA")
            { value = split[1]; }
            if (BookMarkName == "AggregateA2")
            {
                if (split2.Length > 1)
                {
                    if (split2[1].Trim() == "")
        ...
        public string CalculateInvoiceDiscount(EPolicy.TaskControl.CorporatePolicyQuote taskControl, string ReturnType)
        {
            EPolicy.TaskControl.CorporatePolicyQuote taskcontrol2 = (EPolicy.TaskControl.CorporatePolicyQuote)Session["TaskControl"];
        ...
        protected void btnPrintWord_Click(object sender, System.EventArgs e)
        {
            EPolicy.TaskControl.CorporatePolicyQuote taskControl = (EPolicy.TaskControl.CorporatePolicyQuote)Session["TaskControl"];

            if (taskControl.PolicyType.Trim() == "APC" || taskControl.PolicyType.Trim() == "AEC")
            {
                Print();
        ...
        protected void PrintWord(string whereclause, bool IncludeCert)
        {
            ...
            for (int i = 0; i < reports.Rows.Count; i++)
            {
                if (reports.Rows[i]["WordDocument"].ToString().Contains(".pdf"))
                {
                    ...
                    string fullFilePath = currentApplicationPath + "Reports\\Word\\Files\\Corporate\\" + reports.Rows[i]["WordDocument"].ToString();
            ...
            if (IncludeCert == true && taskControl.PolicyType.Trim() == "PP" || taskControl.PolicyType.Trim() == "CF")
            {
        ...
        private List<string> PrintCertificateReports(string certID, int counter, List<string> mergePaths)
        {
            ...
            try
            {
                ...
                else if (taskControl.PolicyType.Trim() == "CF" || taskControl.PolicyType.Trim() == "CE" || taskControl.PolicyType.Trim() == "CFT" || taskControl.PolicyType.Trim() == "CET" || taskControl.PolicyType.Trim() == "APC" || taskControl.PolicyType.Trim() == "CPA")
                {
                    TaskControl.CorporatePolicyQuote taskControlCorporate = (TaskControl.CorporatePolicyQuote)Session["TaskControl"];
                    //-------Initialize reports parameters----
                    ReportParameter[] param = new ReportParameter[11];
