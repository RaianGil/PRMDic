        ...
        <body>
            <form method="post" runat="server">
                ...
                <div class="container-xl mb-4 p-18">
                    <div class="row">
                        <div class="col-md-6">
                            <asp:Label id="Label4" class="fs-16" runat="server">Event List</asp:Label>
                        </div>
                        <div class="col-md-6 f-right">
                            <asp:Button id="btnClose" class="btn-h-30 btn-bg-theme2 btn-r-4" runat="server" Text="Exit" onclick="btnClose_Click"></asp:Button>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <hr>
                    ...
                    <asp:datagrid id="searchIndividual" Height="1px" WIDTH="805px" RUNAT="server" ITEMSTYLE-HORIZONTALALIGN="center" HEADERSTYLE-HORIZONTALALIGN="Center" BACKCOLOR="White" AUTOGENERATECOLUMNS="False" ALLOWPAGING="True" FONT-SIZE="Smaller" FONT-NAMES="Arial"
                        CELLPADDING="0" ALTERNATINGITEMSTYLE-CSSCLASS="HeadForm3" ALTERNATINGITEMSTYLE-BACKCOLOR="#FEFBF6" HEADERSTYLE-CSSCLASS="HeadForm2" HEADERSTYLE-BACKCOLOR="#5C8BAE" ITEMSTYLE-CSSCLASS="HeadForm3" PageSize="20" BORDERCOLOR="#D6E3EA"
                        BORDERWIDTH="1px" BORDERSTYLE="Solid" OnItemCommand="searchIndividual_ItemCommand" OnSelectedIndexChanged="searchIndividual_SelectedIndexChanged">
