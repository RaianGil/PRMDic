...
public partial class AHCPrimaryQuotes : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DataTable dtPRPrimaryLimit = LookupTables.GetTable("AHCRates");
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("FromPage", "AHCPrimaryQuotes.aspx");
    ...
    private void SetDDLLimit(int LimitID, int primaryLimit)
    {
        ...
        DataTable dtPRMEDICRATE2 = EPolicy.TaskControl.Application.GetPRMEDICPrimaryRATEAHC(primaryLimit);
    ...
    protected void ddlPolicyClass_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        DataTable dtPRMEDICRATE2 = EPolicy.TaskControl.Application.GetPRMEDICPrimaryRATEAHC(int.Parse(hdfPrimaryLimit.Value));
        ...
        //Primary
        DataTable dtPRMEDICRATEPRIMARY2 = EPolicy.TaskControl.Application.GetPRMEDICRATEPRIMARYAHCBYISOCODE(int.Parse(this.txtPrateID.Value), txtIsoCode.Text.Trim());
    ...
    protected void btnConvertPrimary_Click(object sender, EventArgs e)
    {
        ...
        taskControl.TaskControlTypeID = 23;
        taskControl.Term = 12;
