...
namespace EPolicy.TaskControl
{
	...
	public class TaskControl
	{
		...
		private DateTime _EntryDate        = DateTime.Parse("12/31/2014");
			...
			int UserID)
		{
			...
			if (dt.Rows.Count > 0)
			{
				...
				switch (TaskControlTypeID)
				{
                    ...
                    case 14:			// Primary Policy Endorsement Quote
                        t = Type.GetType("EPolicy.TaskControl.Policies", true);
                        taskControl = (TaskControl)t.InvokeMember("GetPoliciesEQuotes",
                            BindingFlags.Public | BindingFlags.InvokeMethod | BindingFlags.Static,
                    ...
                    case 19:			// Laboratory Quote 
                        taskControlDesc = "LaboratoryQuotes";
                        t = Type.GetType("EPolicy.TaskControl." + "Laboratory", true);
                        taskControl = (TaskControl)t.InvokeMember("Get" + taskControlDesc,
                            BindingFlags.Public | BindingFlags.InvokeMethod | BindingFlags.Static,
                            null, null, new object[1] { TaskControlID });
                        break;

                    case 20: // Laboratory Policy
                        taskControlDesc = "LaboratoryPolicy";
                        t = Type.GetType("EPolicy.TaskControl." + "Laboratory", true);
                        taskControl = (TaskControl)t.InvokeMember("Get" + taskControlDesc,
                            BindingFlags.Public | BindingFlags.InvokeMethod | BindingFlags.Static,
                            null, null, new object[1] { TaskControlID });
                    ...
                    case 21: //Cyber Quote
                        taskControlDesc = "CyberQuotes";
                        t = Type.GetType("EPolicy.TaskControl." + "Cyber", true);
                        taskControl = (TaskControl)t.InvokeMember("Get" + taskControlDesc,
                            BindingFlags.Public | BindingFlags.InvokeMethod | BindingFlags.Static,
                            null, null, new object[1] { TaskControlID });
                        break;

                    case 22: //Cyber Policy
                        taskControlDesc = "CyberPolicy";
                            t = Type.GetType("EPolicy.TaskControl." + "Cyber", true);
                        taskControl = (TaskControl)t.InvokeMember("Get" + taskControlDesc,
                            BindingFlags.Public | BindingFlags.InvokeMethod | BindingFlags.Static,
                            null, null, new object[1] { TaskControlID });
...
//				errorMessage = "ProspectID is missing or wrong.";
        ...
        private static DataTable GetTaskControlByGroupInTableDB(string Group,string Corporation, int UserID, string BegDate, string EndDate)
        {
            ...
            DbRequestXmlCooker.AttachCookItem("Group",
                SqlDbType.VarChar, 1000, Group.ToString(),
                ref cookItems);

            DbRequestXmlCooker.AttachCookItem("Corporation",
                SqlDbType.VarChar, 1000, Corporation.ToString(),
                ref cookItems);
...
//						this.CommitAudit();
		...
		private XmlDocument GetInsertTaskControlXml()
		{
            ...
            DbRequestXmlCooker.AttachCookItem("City",
                SqlDbType.Int, 0, this.City.ToString(),
                ref cookItems);
		...
		private static TaskControl FillProperties(TaskControl taskControl, int UserID)
		{
            ...
            taskControl.City          = (taskControl._dtTaskControl.Rows[0]["City"]!=System.DBNull.Value) ? (int) taskControl._dtTaskControl.Rows[0]["City"]:0;
