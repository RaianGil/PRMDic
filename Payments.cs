...
//		}
		...
		{	
			DataTable dt = Policy.GetPolicies(this.PolicyClassID,this.PolicyType.Trim(),this.PolicyNo.Trim(),this.Certificate.Trim(),this.Sufijo.Trim(),"",this.Bank.Trim(),UserID);
...
//			}
        ...
        string policyNo, string paymentDate)
        {
            ...
            try
            {
                ...
                this.GetUpdateCheckNoAndDepositDateXml(oldCheckNo, checkNo, depositDate, taskPaymentID));
                Executor.CommitTrans();
            }
            catch (Exception xcp)
            {
        ...
        public void InsertPolicyPaymentImport(int paymentImportID, string paymentDate, string paymentCheck, string paymentAmount, string name, string depositDate, string policyType, string policyNo, string effectiveDate, string status)
        {
            Baldrich.DBRequest.DBRequest Executor = new Baldrich.DBRequest.DBRequest();
            try
            {
                Executor.BeginTrans();
                Executor.Insert("InsertPolicyPaymentImport",
                this.GetUpdatePolicyPaymentImport(paymentImportID, status));
                Executor.CommitTrans();
            }
            catch (Exception xcp)
            {
        ...
        public void UpdatePaymentImportStatus(int paymentImportID, string status)
        {
            Baldrich.DBRequest.DBRequest Executor = new Baldrich.DBRequest.DBRequest();
            try
            {
                Executor.BeginTrans();
                Executor.Update("UpdatePolicyPaymentImport",
                this.GetUpdatePolicyPaymentImport(paymentImportID, status));
                Executor.CommitTrans();
            }
            catch (Exception xcp)
        ...
        private static DataTable GetPolicyForPaymentImports(string policyType, string policyNo, string effectiveYear)
        {
            ...
            DbRequestXmlCooker.AttachCookItem("PolicyType",
                SqlDbType.Char, 2, policyType.Trim(),
                ref cookItems);
        ...
        private XmlDocument GetInsertPolicyPaymentImport(int paymentImportID, string paymentDate, string paymentCheck, string paymentAmount, string name, string depositDate, string policyType, string policyNo, string effectiveDate, string status)
        {
        ...
        private XmlDocument GetUpdatePolicyPaymentImport(int paymentImportID, string status)
        {
